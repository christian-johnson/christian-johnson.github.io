  ...
  return (function () {
      ...
      constructor(e, t) {
        ...
        if (i && i.start <= i.end) {
          ...
          ((r = n > 15 ? "\u2026" + e.slice(n - 15, n) : e.slice(0, n)),
            (a =
              o + 15 < e.length ? e.slice(o, o + 15) + "\u2026" : e.slice(o)),
            (s += r + t + a));
        }
        const a = new Error(s);
        return (
    ...
    var l = {
      ...
      isCharacterBox: function (e) {
        const t = a(e);
        return (
          "mathord" === t.type || "textord" === t.type || "atom" === t.type
        );
      },
      ...
      constructor(e) {
        ...
        for (const t in h)
          if (h.hasOwnProperty(t)) {
            const r = h[t];
            this[t] =
              void 0 !== e[t] ? (r.processor ? r.processor(e[t]) : e[t]) : c(r);
          }
      }
    ...
    function C(e, t, r) {
      ...
      let n = e.charCodeAt(0),
        o = A[t][n];
      if (
        (!o && e[0] in B && ((n = B[e[0]].charCodeAt(0)), (o = A[t][n])),
    ...
    class H {
      ...
      havingStyle(e) {
        return this.style === e
          ? this
          : this.extend({ style: e, size: R(this.textSize, e) });
      }
      havingCrampedStyle() {
        ...
        return (
          this._fontMetrics ||
            (this._fontMetrics = (function (e) {
              let t;
              if (((t = e >= 5 ? 0 : e >= 3 ? 1 : 2), !N[t])) {
                const e = (N[t] = { cssEmPerMu: T.quad[t] / 18 });
                for (const r in T) T.hasOwnProperty(r) && (e[r] = T[r][t]);
              }
              return N[t];
            })(this.size)),
          this._fontMetrics
    ...
    const E = {
      ...
      U = function (e) {
        ...
        for (const e in this.attributes)
          this.attributes.hasOwnProperty(e) &&
      ...
      X = function (e) {
        let t = "<" + e;
        this.classes.length &&
          (t += ' class="' + l.escape(F(this.classes)) + '"');
        let r = "";
        for (const e in this.style)
          this.style.hasOwnProperty(e) &&
            (r += l.hyphenate(e) + ":" + this.style[e] + ";");
        r && (t += ' style="' + l.escape(r) + '"');
        for (const e in this.attributes)
          if (this.attributes.hasOwnProperty(e)) {
            if (Y.test(e)) throw new n("Invalid attribute name '" + e + "'");
    ...
    class Z {
      constructor(e, t, r, n, o, s, i, a) {
        ...
        (l && this.classes.push(l + "_fallback"),
          /[\xee\xef\xed\xec]/.test(this.text) && (this.text = $[this.text]));
      }
      hasClass(e) {
        return this.classes.includes(e);
      }
      toNode() {
        ...
        (this.italic > 0 &&
          ...
          (t.style.marginRight = P(this.italic))),
    ...
    class K {
      ...
      toMarkup() {
        ...
        for (const t in this.attributes)
          Object.prototype.hasOwnProperty.call(this.attributes, t) &&
            (e += " " + t + '="' + l.escape(this.attributes[t]) + '"');
        e += ">";
        for (let t = 0; t < this.children.length; t++)
      ...
      toNode() {
        ...
        return (
          this.alternate
            ...
            : e.setAttribute("d", z[this.pathName]),
          e
        );
      }
      toMarkup() {
        return this.alternate
          ? '<path d="' + l.escape(this.alternate) + '"/>'
          : '<path d="' + l.escape(z[this.pathName]) + '"/>';
      }
    }
    class Q {
      constructor(e) {
    ...
    const te = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
      re = {
        "accent-token": 1,
        mathord: 1,
        "op-token": 1,
    ...
    function se(e, t, r, n, o, s) {
      ((ne[e][o] = { font: t, group: r, replace: n }),
        s && n && (ne[e][n] = ne[e][o]));
    }
    const ie = "math",
      ae = "text",
    ...
    (se(ie, le, ye, "\u2261", "\\equiv", !0),
      ...
      se(ie, le, ye, "\u223c", "\\sim", !0),
      se(ie, le, ye, "\u22a5", "\\perp"),
      se(ie, le, ye, "\u2aaf", "\\preceq", !0),
      se(ie, le, ye, "\u2ab0", "\\succeq", !0),
      se(ie, le, ye, "\u2243", "\\simeq", !0),
      se(ie, le, ye, "\u2223", "\\mid", !0),
      se(ie, le, ye, "\u226a", "\\ll", !0),
      se(ie, le, ye, "\u226b", "\\gg", !0),
      se(ie, le, ye, "\u224d", "\\asymp", !0),
      se(ie, le, ye, "\u2225", "\\parallel"),
      se(ie, le, ye, "\u22c8", "\\bowtie", !0),
      se(ie, le, ye, "\u2323", "\\smile", !0),
      se(ie, le, ye, "\u2291", "\\sqsubseteq", !0),
      se(ie, le, ye, "\u2292", "\\sqsupseteq", !0),
      se(ie, le, ye, "\u2250", "\\doteq", !0),
      se(ie, le, ye, "\u2322", "\\frown", !0),
      se(ie, le, ye, "\u220b", "\\ni", !0),
      se(ie, le, ye, "\u221d", "\\propto", !0),
      se(ie, le, ye, "\u22a2", "\\vdash", !0),
      se(ie, le, ye, "\u22a3", "\\dashv", !0),
      se(ie, le, ye, "\u220b", "\\owns"),
      se(ie, le, be, ".", "\\ldotp"),
      ...
      se(ie, le, we, "&", "\\&"),
      se(ae, le, we, "&", "\\&"),
      se(ie, le, we, "\u2135", "\\aleph", !0),
      se(ie, le, we, "\u2200", "\\forall", !0),
      se(ie, le, we, "\u210f", "\\hbar", !0),
      se(ie, le, we, "\u2203", "\\exists", !0),
      se(ie, le, we, "\u2207", "\\nabla", !0),
      se(ie, le, we, "\u266d", "\\flat", !0),
      se(ie, le, we, "\u2113", "\\ell", !0),
      se(ie, le, we, "\u266e", "\\natural", !0),
      se(ie, le, we, "\u2663", "\\clubsuit", !0),
      se(ie, le, we, "\u2118", "\\wp", !0),
      se(ie, le, we, "\u266f", "\\sharp", !0),
      se(ie, le, we, "\u2662", "\\diamondsuit", !0),
      se(ie, le, we, "\u211c", "\\Re", !0),
      se(ie, le, we, "\u2661", "\\heartsuit", !0),
      se(ie, le, we, "\u2111", "\\Im", !0),
      se(ie, le, we, "\u2660", "\\spadesuit", !0),
      se(ie, le, we, "\xa7", "\\S", !0),
      se(ae, le, we, "\xa7", "\\S"),
      se(ie, le, we, "\xb6", "\\P", !0),
      se(ae, le, we, "\xb6", "\\P"),
      se(ie, le, we, "\u2020", "\\dag"),
      se(ae, le, we, "\u2020", "\\dag"),
      se(ae, le, we, "\u2020", "\\textdagger"),
      se(ie, le, we, "\u2021", "\\ddag"),
      se(ae, le, we, "\u2021", "\\ddag"),
      se(ae, le, we, "\u2021", "\\textdaggerdbl"),
      se(ie, le, pe, "\u23b1", "\\rmoustache", !0),
      se(ie, le, fe, "\u23b0", "\\lmoustache", !0),
      se(ie, le, pe, "\u27ef", "\\rgroup", !0),
      se(ie, le, fe, "\u27ee", "\\lgroup", !0),
      se(ie, le, me, "\u2213", "\\mp", !0),
      se(ie, le, me, "\u2296", "\\ominus", !0),
      se(ie, le, me, "\u228e", "\\uplus", !0),
      se(ie, le, me, "\u2293", "\\sqcap", !0),
      se(ie, le, me, "\u2217", "\\ast"),
      se(ie, le, me, "\u2294", "\\sqcup", !0),
      se(ie, le, me, "\u25ef", "\\bigcirc", !0),
      se(ie, le, me, "\u2219", "\\bullet", !0),
      se(ie, le, me, "\u2021", "\\ddagger"),
      se(ie, le, me, "\u2240", "\\wr", !0),
      se(ie, le, me, "\u2a3f", "\\amalg"),
      se(ie, le, me, "&", "\\And"),
      se(ie, le, ye, "\u27f5", "\\longleftarrow", !0),
      se(ie, le, ye, "\u21d0", "\\Leftarrow", !0),
      se(ie, le, ye, "\u27f8", "\\Longleftarrow", !0),
      se(ie, le, ye, "\u27f6", "\\longrightarrow", !0),
      se(ie, le, ye, "\u21d2", "\\Rightarrow", !0),
      se(ie, le, ye, "\u27f9", "\\Longrightarrow", !0),
      se(ie, le, ye, "\u2194", "\\leftrightarrow", !0),
      se(ie, le, ye, "\u27f7", "\\longleftrightarrow", !0),
      se(ie, le, ye, "\u21d4", "\\Leftrightarrow", !0),
      se(ie, le, ye, "\u27fa", "\\Longleftrightarrow", !0),
      se(ie, le, ye, "\u21a6", "\\mapsto", !0),
      se(ie, le, ye, "\u27fc", "\\longmapsto", !0),
      se(ie, le, ye, "\u2197", "\\nearrow", !0),
      se(ie, le, ye, "\u21a9", "\\hookleftarrow", !0),
      se(ie, le, ye, "\u21aa", "\\hookrightarrow", !0),
      se(ie, le, ye, "\u2198", "\\searrow", !0),
      se(ie, le, ye, "\u21bc", "\\leftharpoonup", !0),
      se(ie, le, ye, "\u21c0", "\\rightharpoonup", !0),
      se(ie, le, ye, "\u2199", "\\swarrow", !0),
      se(ie, le, ye, "\u21bd", "\\leftharpoondown", !0),
      se(ie, le, ye, "\u21c1", "\\rightharpoondown", !0),
      se(ie, le, ye, "\u2196", "\\nwarrow", !0),
      se(ie, le, ye, "\u21cc", "\\rightleftharpoons", !0),
      se(ie, he, ye, "\u226e", "\\nless", !0),
      se(ie, he, ye, "\ue010", "\\@nleqslant"),
      se(ie, he, ye, "\ue011", "\\@nleqq"),
      se(ie, he, ye, "\u2a87", "\\lneq", !0),
      se(ie, he, ye, "\u2268", "\\lneqq", !0),
      se(ie, he, ye, "\ue00c", "\\@lvertneqq"),
      se(ie, he, ye, "\u22e6", "\\lnsim", !0),
      se(ie, he, ye, "\u2a89", "\\lnapprox", !0),
      se(ie, he, ye, "\u2280", "\\nprec", !0),
      se(ie, he, ye, "\u22e0", "\\npreceq", !0),
      se(ie, he, ye, "\u22e8", "\\precnsim", !0),
      se(ie, he, ye, "\u2ab9", "\\precnapprox", !0),
      se(ie, he, ye, "\u2241", "\\nsim", !0),
      se(ie, he, ye, "\ue006", "\\@nshortmid"),
      se(ie, he, ye, "\u2224", "\\nmid", !0),
      se(ie, he, ye, "\u22ac", "\\nvdash", !0),
      se(ie, he, ye, "\u22ad", "\\nvDash", !0),
      se(ie, he, ye, "\u22ea", "\\ntriangleleft"),
      se(ie, he, ye, "\u22ec", "\\ntrianglelefteq", !0),
      se(ie, he, ye, "\u228a", "\\subsetneq", !0),
      se(ie, he, ye, "\ue01a", "\\@varsubsetneq"),
      se(ie, he, ye, "\u2acb", "\\subsetneqq", !0),
      se(ie, he, ye, "\ue017", "\\@varsubsetneqq"),
      se(ie, he, ye, "\u226f", "\\ngtr", !0),
      se(ie, he, ye, "\ue00f", "\\@ngeqslant"),
      se(ie, he, ye, "\ue00e", "\\@ngeqq"),
      se(ie, he, ye, "\u2a88", "\\gneq", !0),
      se(ie, he, ye, "\u2269", "\\gneqq", !0),
      se(ie, he, ye, "\ue00d", "\\@gvertneqq"),
      se(ie, he, ye, "\u22e7", "\\gnsim", !0),
      se(ie, he, ye, "\u2a8a", "\\gnapprox", !0),
      se(ie, he, ye, "\u2281", "\\nsucc", !0),
      se(ie, he, ye, "\u22e1", "\\nsucceq", !0),
      se(ie, he, ye, "\u22e9", "\\succnsim", !0),
      se(ie, he, ye, "\u2aba", "\\succnapprox", !0),
      se(ie, he, ye, "\u2246", "\\ncong", !0),
      se(ie, he, ye, "\ue007", "\\@nshortparallel"),
      se(ie, he, ye, "\u2226", "\\nparallel", !0),
      se(ie, he, ye, "\u22af", "\\nVDash", !0),
      se(ie, he, ye, "\u22eb", "\\ntriangleright"),
      se(ie, he, ye, "\u22ed", "\\ntrianglerighteq", !0),
      se(ie, he, ye, "\ue018", "\\@nsupseteqq"),
      se(ie, he, ye, "\u228b", "\\supsetneq", !0),
      se(ie, he, ye, "\ue01b", "\\@varsupsetneq"),
      se(ie, he, ye, "\u2acc", "\\supsetneqq", !0),
      se(ie, he, ye, "\ue019", "\\@varsupsetneqq"),
      se(ie, he, ye, "\u22ae", "\\nVdash", !0),
      se(ie, he, ye, "\u2ab5", "\\precneqq", !0),
      se(ie, he, ye, "\u2ab6", "\\succneqq", !0),
      se(ie, he, ye, "\ue016", "\\@nsubseteqq"),
      se(ie, he, me, "\u22b4", "\\unlhd"),
      se(ie, he, me, "\u22b5", "\\unrhd"),
      se(ie, he, ye, "\u219a", "\\nleftarrow", !0),
      se(ie, he, ye, "\u219b", "\\nrightarrow", !0),
      ...
      se(ie, he, ye, "\u21ae", "\\nleftrightarrow", !0),
      se(ie, he, ye, "\u21ce", "\\nLeftrightarrow", !0),
      se(ie, he, ye, "\u25b3", "\\vartriangle"),
      se(ie, he, we, "\u210f", "\\hslash"),
      se(ie, he, we, "\u25bd", "\\triangledown"),
      se(ie, he, we, "\u25ca", "\\lozenge"),
      se(ie, he, we, "\u24c8", "\\circledS"),
      se(ie, he, we, "\xae", "\\circledR"),
      se(ae, he, we, "\xae", "\\circledR"),
      se(ie, he, we, "\u2221", "\\measuredangle", !0),
      se(ie, he, we, "\u2204", "\\nexists"),
      se(ie, he, we, "\u2127", "\\mho"),
      se(ie, he, we, "\u2132", "\\Finv", !0),
      se(ie, he, we, "\u2141", "\\Game", !0),
      se(ie, he, we, "\u2035", "\\backprime"),
      se(ie, he, we, "\u25b2", "\\blacktriangle"),
      se(ie, he, we, "\u25bc", "\\blacktriangledown"),
      se(ie, he, we, "\u25a0", "\\blacksquare"),
      se(ie, he, we, "\u29eb", "\\blacklozenge"),
      se(ie, he, we, "\u2605", "\\bigstar"),
      se(ie, he, we, "\u2222", "\\sphericalangle", !0),
      se(ie, he, we, "\u2201", "\\complement", !0),
      se(ie, he, we, "\xf0", "\\eth", !0),
      se(ae, le, we, "\xf0", "\xf0"),
      se(ie, he, we, "\u2571", "\\diagup"),
      se(ie, he, we, "\u2572", "\\diagdown"),
      se(ie, he, we, "\u25a1", "\\square"),
      se(ie, he, we, "\u25a1", "\\Box"),
      se(ie, he, we, "\u25ca", "\\Diamond"),
      se(ie, he, we, "\xa5", "\\yen", !0),
      se(ae, he, we, "\xa5", "\\yen", !0),
      se(ie, he, we, "\u2713", "\\checkmark", !0),
      se(ae, he, we, "\u2713", "\\checkmark"),
      se(ie, he, we, "\u2136", "\\beth", !0),
      se(ie, he, we, "\u2138", "\\daleth", !0),
      se(ie, he, we, "\u2137", "\\gimel", !0),
      se(ie, he, we, "\u03dd", "\\digamma", !0),
      se(ie, he, we, "\u03f0", "\\varkappa"),
      se(ie, he, fe, "\u250c", "\\@ulcorner", !0),
      se(ie, he, pe, "\u2510", "\\@urcorner", !0),
      se(ie, he, fe, "\u2514", "\\@llcorner", !0),
      se(ie, he, pe, "\u2518", "\\@lrcorner", !0),
      se(ie, he, ye, "\u2266", "\\leqq", !0),
      se(ie, he, ye, "\u2a7d", "\\leqslant", !0),
      se(ie, he, ye, "\u2a95", "\\eqslantless", !0),
      se(ie, he, ye, "\u2272", "\\lesssim", !0),
      se(ie, he, ye, "\u2a85", "\\lessapprox", !0),
      se(ie, he, ye, "\u224a", "\\approxeq", !0),
      se(ie, he, me, "\u22d6", "\\lessdot"),
      se(ie, he, ye, "\u22d8", "\\lll", !0),
      se(ie, he, ye, "\u2276", "\\lessgtr", !0),
      se(ie, he, ye, "\u22da", "\\lesseqgtr", !0),
      se(ie, he, ye, "\u2a8b", "\\lesseqqgtr", !0),
      se(ie, he, ye, "\u2251", "\\doteqdot"),
      se(ie, he, ye, "\u2253", "\\risingdotseq", !0),
      se(ie, he, ye, "\u2252", "\\fallingdotseq", !0),
      se(ie, he, ye, "\u223d", "\\backsim", !0),
      se(ie, he, ye, "\u22cd", "\\backsimeq", !0),
      se(ie, he, ye, "\u2ac5", "\\subseteqq", !0),
      se(ie, he, ye, "\u22d0", "\\Subset", !0),
      se(ie, he, ye, "\u228f", "\\sqsubset", !0),
      se(ie, he, ye, "\u227c", "\\preccurlyeq", !0),
      se(ie, he, ye, "\u22de", "\\curlyeqprec", !0),
      se(ie, he, ye, "\u227e", "\\precsim", !0),
      se(ie, he, ye, "\u2ab7", "\\precapprox", !0),
      se(ie, he, ye, "\u22b2", "\\vartriangleleft"),
      se(ie, he, ye, "\u22b4", "\\trianglelefteq"),
      se(ie, he, ye, "\u22a8", "\\vDash", !0),
      se(ie, he, ye, "\u22aa", "\\Vvdash", !0),
      se(ie, he, ye, "\u2323", "\\smallsmile"),
      se(ie, he, ye, "\u2322", "\\smallfrown"),
      se(ie, he, ye, "\u224f", "\\bumpeq", !0),
      se(ie, he, ye, "\u224e", "\\Bumpeq", !0),
      se(ie, he, ye, "\u2267", "\\geqq", !0),
      se(ie, he, ye, "\u2a7e", "\\geqslant", !0),
      se(ie, he, ye, "\u2a96", "\\eqslantgtr", !0),
      se(ie, he, ye, "\u2273", "\\gtrsim", !0),
      se(ie, he, ye, "\u2a86", "\\gtrapprox", !0),
      se(ie, he, me, "\u22d7", "\\gtrdot"),
      se(ie, he, ye, "\u22d9", "\\ggg", !0),
      se(ie, he, ye, "\u2277", "\\gtrless", !0),
      se(ie, he, ye, "\u22db", "\\gtreqless", !0),
      se(ie, he, ye, "\u2a8c", "\\gtreqqless", !0),
      se(ie, he, ye, "\u2256", "\\eqcirc", !0),
      se(ie, he, ye, "\u2257", "\\circeq", !0),
      se(ie, he, ye, "\u225c", "\\triangleq", !0),
      se(ie, he, ye, "\u223c", "\\thicksim"),
      se(ie, he, ye, "\u2248", "\\thickapprox"),
      se(ie, he, ye, "\u2ac6", "\\supseteqq", !0),
      se(ie, he, ye, "\u22d1", "\\Supset", !0),
      se(ie, he, ye, "\u2290", "\\sqsupset", !0),
      se(ie, he, ye, "\u227d", "\\succcurlyeq", !0),
      se(ie, he, ye, "\u22df", "\\curlyeqsucc", !0),
      se(ie, he, ye, "\u227f", "\\succsim", !0),
      se(ie, he, ye, "\u2ab8", "\\succapprox", !0),
      se(ie, he, ye, "\u22b3", "\\vartriangleright"),
      se(ie, he, ye, "\u22b5", "\\trianglerighteq"),
      se(ie, he, ye, "\u22a9", "\\Vdash", !0),
      se(ie, he, ye, "\u2223", "\\shortmid"),
      se(ie, he, ye, "\u2225", "\\shortparallel"),
      se(ie, he, ye, "\u226c", "\\between", !0),
      se(ie, he, ye, "\u22d4", "\\pitchfork", !0),
      se(ie, he, ye, "\u221d", "\\varpropto"),
      se(ie, he, ye, "\u25c0", "\\blacktriangleleft"),
      se(ie, he, ye, "\u2234", "\\therefore", !0),
      se(ie, he, ye, "\u220d", "\\backepsilon"),
      se(ie, he, ye, "\u25b6", "\\blacktriangleright"),
      se(ie, he, ye, "\u2235", "\\because", !0),
      se(ie, he, ye, "\u22d8", "\\llless"),
      se(ie, he, ye, "\u22d9", "\\gggtr"),
      se(ie, he, me, "\u22b2", "\\lhd"),
      se(ie, he, me, "\u22b3", "\\rhd"),
      ...
      se(ie, le, ye, "\u22c8", "\\Join"),
      se(ie, he, ye, "\u2251", "\\Doteq", !0),
      se(ie, he, me, "\u2214", "\\dotplus", !0),
      se(ie, he, me, "\u2216", "\\smallsetminus"),
      se(ie, he, me, "\u22d2", "\\Cap", !0),
      se(ie, he, me, "\u22d3", "\\Cup", !0),
      se(ie, he, me, "\u2a5e", "\\doublebarwedge", !0),
      se(ie, he, me, "\u229f", "\\boxminus", !0),
      se(ie, he, me, "\u229e", "\\boxplus", !0),
      se(ie, he, me, "\u22c7", "\\divideontimes", !0),
      se(ie, he, me, "\u22c9", "\\ltimes", !0),
      se(ie, he, me, "\u22ca", "\\rtimes", !0),
      se(ie, he, me, "\u22cb", "\\leftthreetimes", !0),
      se(ie, he, me, "\u22cc", "\\rightthreetimes", !0),
      se(ie, he, me, "\u22cf", "\\curlywedge", !0),
      se(ie, he, me, "\u22ce", "\\curlyvee", !0),
      se(ie, he, me, "\u229d", "\\circleddash", !0),
      se(ie, he, me, "\u229b", "\\circledast", !0),
      se(ie, he, me, "\u22c5", "\\centerdot"),
      se(ie, he, me, "\u22ba", "\\intercal", !0),
      se(ie, he, me, "\u22d2", "\\doublecap"),
      se(ie, he, me, "\u22d3", "\\doublecup"),
      se(ie, he, me, "\u22a0", "\\boxtimes", !0),
      se(ie, he, ye, "\u21e2", "\\dashrightarrow", !0),
      se(ie, he, ye, "\u21e0", "\\dashleftarrow", !0),
      se(ie, he, ye, "\u21c7", "\\leftleftarrows", !0),
      se(ie, he, ye, "\u21c6", "\\leftrightarrows", !0),
      se(ie, he, ye, "\u21da", "\\Lleftarrow", !0),
      se(ie, he, ye, "\u219e", "\\twoheadleftarrow", !0),
      se(ie, he, ye, "\u21a2", "\\leftarrowtail", !0),
      se(ie, he, ye, "\u21ab", "\\looparrowleft", !0),
      se(ie, he, ye, "\u21cb", "\\leftrightharpoons", !0),
      se(ie, he, ye, "\u21b6", "\\curvearrowleft", !0),
      se(ie, he, ye, "\u21ba", "\\circlearrowleft", !0),
      se(ie, he, ye, "\u21b0", "\\Lsh", !0),
      se(ie, he, ye, "\u21c8", "\\upuparrows", !0),
      se(ie, he, ye, "\u21bf", "\\upharpoonleft", !0),
      se(ie, he, ye, "\u21c3", "\\downharpoonleft", !0),
      se(ie, le, ye, "\u22b6", "\\origof", !0),
      se(ie, le, ye, "\u22b7", "\\imageof", !0),
      se(ie, he, ye, "\u22b8", "\\multimap", !0),
      se(ie, he, ye, "\u21ad", "\\leftrightsquigarrow", !0),
      se(ie, he, ye, "\u21c9", "\\rightrightarrows", !0),
      se(ie, he, ye, "\u21c4", "\\rightleftarrows", !0),
      se(ie, he, ye, "\u21a0", "\\twoheadrightarrow", !0),
      se(ie, he, ye, "\u21a3", "\\rightarrowtail", !0),
      se(ie, he, ye, "\u21ac", "\\looparrowright", !0),
      se(ie, he, ye, "\u21b7", "\\curvearrowright", !0),
      se(ie, he, ye, "\u21bb", "\\circlearrowright", !0),
      se(ie, he, ye, "\u21b1", "\\Rsh", !0),
      se(ie, he, ye, "\u21ca", "\\downdownarrows", !0),
      se(ie, he, ye, "\u21be", "\\upharpoonright", !0),
      se(ie, he, ye, "\u21c2", "\\downharpoonright", !0),
      se(ie, he, ye, "\u21dd", "\\rightsquigarrow", !0),
      se(ie, he, ye, "\u21dd", "\\leadsto"),
      se(ie, he, ye, "\u21db", "\\Rrightarrow", !0),
      se(ie, he, ye, "\u21be", "\\restriction"),
      se(ie, le, we, "\u2018", "`"),
      se(ie, le, we, "$", "\\$"),
      se(ae, le, we, "$", "\\$"),
      se(ae, le, we, "$", "\\textdollar"),
      se(ie, le, we, "%", "\\%"),
      se(ae, le, we, "%", "\\%"),
      se(ie, le, we, "_", "\\_"),
      se(ae, le, we, "_", "\\_"),
      se(ae, le, we, "_", "\\textunderscore"),
      se(ie, le, we, "\u2220", "\\angle", !0),
      se(ie, le, we, "\u221e", "\\infty", !0),
      se(ie, le, we, "\u2032", "\\prime"),
      se(ie, le, we, "\u25b3", "\\triangle"),
      se(ie, le, we, "\u0393", "\\Gamma", !0),
      se(ie, le, we, "\u0394", "\\Delta", !0),
      se(ie, le, we, "\u0398", "\\Theta", !0),
      se(ie, le, we, "\u039b", "\\Lambda", !0),
      se(ie, le, we, "\u039e", "\\Xi", !0),
      se(ie, le, we, "\u03a0", "\\Pi", !0),
      se(ie, le, we, "\u03a3", "\\Sigma", !0),
      se(ie, le, we, "\u03a5", "\\Upsilon", !0),
      se(ie, le, we, "\u03a6", "\\Phi", !0),
      se(ie, le, we, "\u03a8", "\\Psi", !0),
      se(ie, le, we, "\u03a9", "\\Omega", !0),
      se(ie, le, we, "A", "\u0391"),
      se(ie, le, we, "B", "\u0392"),
      se(ie, le, we, "E", "\u0395"),
      se(ie, le, we, "Z", "\u0396"),
      ...
      se(ie, le, we, "X", "\u03a7"),
      se(ie, le, we, "\xac", "\\neg", !0),
      se(ie, le, we, "\xac", "\\lnot"),
      se(ie, le, we, "\u22a4", "\\top"),
      se(ie, le, we, "\u22a5", "\\bot"),
      se(ie, le, we, "\u2205", "\\emptyset"),
      se(ie, he, we, "\u2205", "\\varnothing"),
      se(ie, le, de, "\u03b1", "\\alpha", !0),
      se(ie, le, de, "\u03b2", "\\beta", !0),
      se(ie, le, de, "\u03b3", "\\gamma", !0),
      se(ie, le, de, "\u03b4", "\\delta", !0),
      se(ie, le, de, "\u03f5", "\\epsilon", !0),
      se(ie, le, de, "\u03b6", "\\zeta", !0),
      se(ie, le, de, "\u03b7", "\\eta", !0),
      se(ie, le, de, "\u03b8", "\\theta", !0),
      se(ie, le, de, "\u03b9", "\\iota", !0),
      se(ie, le, de, "\u03ba", "\\kappa", !0),
      se(ie, le, de, "\u03bb", "\\lambda", !0),
      se(ie, le, de, "\u03bc", "\\mu", !0),
      se(ie, le, de, "\u03bd", "\\nu", !0),
      se(ie, le, de, "\u03be", "\\xi", !0),
      se(ie, le, de, "\u03bf", "\\omicron", !0),
      se(ie, le, de, "\u03c0", "\\pi", !0),
      se(ie, le, de, "\u03c1", "\\rho", !0),
      se(ie, le, de, "\u03c3", "\\sigma", !0),
      se(ie, le, de, "\u03c4", "\\tau", !0),
      se(ie, le, de, "\u03c5", "\\upsilon", !0),
      se(ie, le, de, "\u03d5", "\\phi", !0),
      se(ie, le, de, "\u03c7", "\\chi", !0),
      se(ie, le, de, "\u03c8", "\\psi", !0),
      se(ie, le, de, "\u03c9", "\\omega", !0),
      se(ie, le, de, "\u03b5", "\\varepsilon", !0),
      se(ie, le, de, "\u03d1", "\\vartheta", !0),
      se(ie, le, de, "\u03d6", "\\varpi", !0),
      se(ie, le, de, "\u03f1", "\\varrho", !0),
      se(ie, le, de, "\u03c2", "\\varsigma", !0),
      se(ie, le, de, "\u03c6", "\\varphi", !0),
      se(ie, le, me, "\u2217", "*", !0),
      se(ie, le, me, "+", "+"),
      se(ie, le, me, "\u2212", "-", !0),
      se(ie, le, me, "\u22c5", "\\cdot", !0),
      se(ie, le, me, "\u2218", "\\circ", !0),
      se(ie, le, me, "\xf7", "\\div", !0),
      se(ie, le, me, "\xb1", "\\pm", !0),
      se(ie, le, me, "\xd7", "\\times", !0),
      se(ie, le, me, "\u2229", "\\cap", !0),
      se(ie, le, me, "\u222a", "\\cup", !0),
      se(ie, le, me, "\u2216", "\\setminus", !0),
      se(ie, le, me, "\u2227", "\\land"),
      se(ie, le, me, "\u2228", "\\lor"),
      se(ie, le, me, "\u2227", "\\wedge", !0),
      se(ie, le, me, "\u2228", "\\vee", !0),
      se(ie, le, we, "\u221a", "\\surd"),
      se(ie, le, fe, "\u27e8", "\\langle", !0),
      se(ie, le, fe, "\u2223", "\\lvert"),
      se(ie, le, fe, "\u2225", "\\lVert"),
      se(ie, le, pe, "?", "?"),
      se(ie, le, pe, "!", "!"),
      se(ie, le, pe, "\u27e9", "\\rangle", !0),
      se(ie, le, pe, "\u2223", "\\rvert"),
      se(ie, le, pe, "\u2225", "\\rVert"),
      se(ie, le, ye, "=", "="),
      se(ie, le, ye, ":", ":"),
      se(ie, le, ye, "\u2248", "\\approx", !0),
      se(ie, le, ye, "\u2245", "\\cong", !0),
      se(ie, le, ye, "\u2265", "\\ge"),
      se(ie, le, ye, "\u2265", "\\geq", !0),
      se(ie, le, ye, "\u2190", "\\gets"),
      ...
      se(ie, le, ye, "\u2208", "\\in", !0),
      se(ie, le, ye, "\ue020", "\\@not"),
      se(ie, le, ye, "\u2282", "\\subset", !0),
      se(ie, le, ye, "\u2283", "\\supset", !0),
      se(ie, le, ye, "\u2286", "\\subseteq", !0),
      se(ie, le, ye, "\u2287", "\\supseteq", !0),
      se(ie, he, ye, "\u2288", "\\nsubseteq", !0),
      se(ie, he, ye, "\u2289", "\\nsupseteq", !0),
      se(ie, le, ye, "\u22a8", "\\models"),
      se(ie, le, ye, "\u2190", "\\leftarrow", !0),
      ...
      se(ie, he, ye, "\u2270", "\\nleq", !0),
      se(ie, le, xe, "\xa0", "\\ "),
      se(ie, le, xe, "\xa0", "\\space"),
      se(ie, le, xe, "\xa0", "\\nobreakspace"),
      se(ae, le, xe, "\xa0", "\\ "),
      se(ae, le, xe, "\xa0", " "),
      se(ae, le, xe, "\xa0", "\\space"),
      se(ae, le, xe, "\xa0", "\\nobreakspace"),
      se(ie, le, xe, null, "\\nobreak"),
      se(ie, le, xe, null, "\\allowbreak"),
      se(ie, le, be, ",", ","),
      se(ie, le, be, ";", ";"),
      se(ie, he, me, "\u22bc", "\\barwedge", !0),
      se(ie, he, me, "\u22bb", "\\veebar", !0),
      se(ie, le, me, "\u2299", "\\odot", !0),
      se(ie, le, me, "\u2295", "\\oplus", !0),
      se(ie, le, me, "\u2297", "\\otimes", !0),
      se(ie, le, we, "\u2202", "\\partial", !0),
      se(ie, le, me, "\u2298", "\\oslash", !0),
      se(ie, he, me, "\u229a", "\\circledcirc", !0),
      se(ie, he, me, "\u22a1", "\\boxdot", !0),
      se(ie, le, me, "\u25b3", "\\bigtriangleup"),
      se(ie, le, me, "\u25bd", "\\bigtriangledown"),
      se(ie, le, me, "\u2020", "\\dagger"),
      se(ie, le, me, "\u22c4", "\\diamond"),
      se(ie, le, me, "\u22c6", "\\star"),
      se(ie, le, me, "\u25c3", "\\triangleleft"),
      se(ie, le, me, "\u25b9", "\\triangleright"),
      se(ie, le, fe, "{", "\\{"),
      se(ae, le, we, "{", "\\{"),
      se(ae, le, we, "{", "\\textbraceleft"),
      se(ie, le, pe, "}", "\\}"),
      se(ae, le, we, "}", "\\}"),
      se(ae, le, we, "}", "\\textbraceright"),
      se(ie, le, fe, "{", "\\lbrace"),
      se(ie, le, pe, "}", "\\rbrace"),
      se(ie, le, fe, "[", "\\lbrack", !0),
      se(ae, le, we, "[", "\\lbrack", !0),
      se(ie, le, pe, "]", "\\rbrack", !0),
      se(ae, le, we, "]", "\\rbrack", !0),
      se(ie, le, fe, "(", "\\lparen", !0),
      se(ie, le, pe, ")", "\\rparen", !0),
      se(ae, le, we, "<", "\\textless", !0),
      se(ae, le, we, ">", "\\textgreater", !0),
      se(ie, le, fe, "\u230a", "\\lfloor", !0),
      se(ie, le, pe, "\u230b", "\\rfloor", !0),
      se(ie, le, fe, "\u2308", "\\lceil", !0),
      se(ie, le, pe, "\u2309", "\\rceil", !0),
      se(ie, le, we, "\\", "\\backslash"),
      se(ie, le, we, "\u2223", "|"),
      se(ie, le, we, "\u2223", "\\vert"),
      se(ae, le, we, "|", "\\textbar", !0),
      se(ie, le, we, "\u2225", "\\|"),
      se(ie, le, we, "\u2225", "\\Vert"),
      se(ae, le, we, "\u2225", "\\textbardbl"),
      se(ae, le, we, "~", "\\textasciitilde"),
      se(ae, le, we, "\\", "\\textbackslash"),
      se(ae, le, we, "^", "\\textasciicircum"),
      se(ie, le, ye, "\u2191", "\\uparrow", !0),
      se(ie, le, ye, "\u21d1", "\\Uparrow", !0),
      se(ie, le, ye, "\u2193", "\\downarrow", !0),
      se(ie, le, ye, "\u21d3", "\\Downarrow", !0),
      se(ie, le, ye, "\u2195", "\\updownarrow", !0),
      se(ie, le, ye, "\u21d5", "\\Updownarrow", !0),
      se(ie, le, ge, "\u2210", "\\coprod"),
      se(ie, le, ge, "\u22c1", "\\bigvee"),
      se(ie, le, ge, "\u22c0", "\\bigwedge"),
      se(ie, le, ge, "\u2a04", "\\biguplus"),
      se(ie, le, ge, "\u22c2", "\\bigcap"),
      se(ie, le, ge, "\u22c3", "\\bigcup"),
      se(ie, le, ge, "\u222b", "\\int"),
      se(ie, le, ge, "\u222b", "\\intop"),
      ...
      se(ie, le, ge, "\u220f", "\\prod"),
      se(ie, le, ge, "\u2211", "\\sum"),
      se(ie, le, ge, "\u2a02", "\\bigotimes"),
      se(ie, le, ge, "\u2a01", "\\bigoplus"),
      se(ie, le, ge, "\u2a00", "\\bigodot"),
      se(ie, le, ge, "\u222e", "\\oint"),
      se(ie, le, ge, "\u222f", "\\oiint"),
      se(ie, le, ge, "\u2230", "\\oiiint"),
      se(ie, le, ge, "\u2a06", "\\bigsqcup"),
      se(ie, le, ge, "\u222b", "\\smallint"),
      se(ae, le, ue, "\u2026", "\\textellipsis"),
      se(ie, le, ue, "\u2026", "\\mathellipsis"),
      se(ae, le, ue, "\u2026", "\\ldots", !0),
      se(ie, le, ue, "\u2026", "\\ldots", !0),
      se(ie, le, ue, "\u22ef", "\\@cdots", !0),
      se(ie, le, ue, "\u22f1", "\\ddots", !0),
      se(ie, le, we, "\u22ee", "\\varvdots"),
      se(ae, le, we, "\u22ee", "\\varvdots"),
      se(ie, le, ce, "\u02ca", "\\acute"),
      se(ie, le, ce, "\u02cb", "\\grave"),
      se(ie, le, ce, "\xa8", "\\ddot"),
      se(ie, le, ce, "~", "\\tilde"),
      se(ie, le, ce, "\u02c9", "\\bar"),
      se(ie, le, ce, "\u02d8", "\\breve"),
      se(ie, le, ce, "\u02c7", "\\check"),
      ...
      se(ae, le, we, "\u0131", "\\i", !0),
      se(ae, le, we, "\u0237", "\\j", !0),
      se(ae, le, we, "\xdf", "\\ss", !0),
      se(ae, le, we, "\xe6", "\\ae", !0),
      se(ae, le, we, "\u0153", "\\oe", !0),
      se(ae, le, we, "\xf8", "\\o", !0),
      se(ae, le, we, "\xc6", "\\AE", !0),
      se(ae, le, we, "\u0152", "\\OE", !0),
      se(ae, le, we, "\xd8", "\\O", !0),
      se(ae, le, ce, "\u02ca", "\\'"),
      se(ae, le, ce, "\u02cb", "\\`"),
      ...
      se(ae, le, ce, "\xa8", '\\"'),
      se(ae, le, ce, "\u02dd", "\\H"),
      se(ae, le, ce, "\u25ef", "\\textcircled"));
    const ve = { "--": !0, "---": !0, "``": !0, "''": !0 };
    (se(ae, le, we, "\u2013", "--", !0),
      se(ae, le, we, "\u2013", "\\textendash"),
      se(ae, le, we, "\u2014", "---", !0),
      se(ae, le, we, "\u2014", "\\textemdash"),
      se(ae, le, we, "\u2018", "`", !0),
      se(ae, le, we, "\u2018", "\\textquoteleft"),
      se(ae, le, we, "\u2019", "'", !0),
      se(ae, le, we, "\u2019", "\\textquoteright"),
      se(ae, le, we, "\u201c", "``", !0),
      se(ae, le, we, "\u201c", "\\textquotedblleft"),
      se(ae, le, we, "\u201d", "''", !0),
      se(ae, le, we, "\u201d", "\\textquotedblright"),
      se(ie, le, we, "\xb0", "\\degree", !0),
      se(ae, le, we, "\xb0", "\\degree"),
      se(ae, le, we, "\xb0", "\\textdegree", !0),
      se(ie, le, we, "\xa3", "\\pounds"),
      se(ie, le, we, "\xa3", "\\mathsterling", !0),
      se(ae, le, we, "\xa3", "\\pounds"),
      se(ae, le, we, "\xa3", "\\textsterling", !0),
      se(ie, he, we, "\u2720", "\\maltese"),
      se(ae, he, we, "\u2720", "\\maltese"));
    const ke = '0123456789/@."';
    for (let e = 0; e < 14; e++) {
    ...
    for (let e = 0; e < 52; e++) {
      const t = Me.charAt(e);
      ((ze = String.fromCharCode(55349, 56320 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56372 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56424 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56580 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56684 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56736 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56788 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56840 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 56944 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        e < 26 &&
          ((ze = String.fromCharCode(55349, 56632 + e)),
          se(ie, le, de, t, ze),
          se(ae, le, we, t, ze),
          (ze = String.fromCharCode(55349, 56476 + e)),
          se(ie, le, de, t, ze),
          se(ae, le, we, t, ze)));
    }
    ((ze = String.fromCharCode(55349, 56668)),
      se(ie, le, de, "k", ze),
      se(ae, le, we, "k", ze));
    for (let e = 0; e < 10; e++) {
      const t = e.toString();
      ((ze = String.fromCharCode(55349, 57294 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 57314 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 57324 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze),
        (ze = String.fromCharCode(55349, 57334 + e)),
        se(ie, le, de, t, ze),
        se(ae, le, we, t, ze));
    }
    ...
    const Ne = function (e, t, r) {
        return (
          oe[r][e] && oe[r][e].replace && (e = oe[r][e].replace),
          { value: e, metrics: C(e, t, r) }
        );
      },
      qe = function (e, t, r, n, o) {
        ...
        if (((e = s.value), i)) {
          ...
          (("text" === r || (n && "mathit" === n.font)) && (t = 0),
            (a = new Z(e, i.height, i.depth, t, i.skew, i.width, o)));
        } else
          ("undefined" != typeof console &&
            console.warn(
    ...
    var Pe = {
      ...
      mathsym: function (e, t, r, n) {
        return (
          void 0 === n && (n = []),
          "boldsymbol" === r.font && Ne(e, "Main-Bold", t).metrics
            ? qe(e, "Main-Bold", t, r, n.concat(["mathbf"]))
            : "\\" === e || "main" === oe[t][e].font
              ? qe(e, "Main-Regular", t, r, n)
              : qe(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
        );
      },
      makeSpan: He,
      makeSvgSpan: Oe,
      makeLineSpan: function (e, t, r) {
        ...
        return (
          ...
          (n.style.borderBottomWidth = P(n.height)),
          (n.maxFontSize = 1),
          n
        );
      },
      ...
      wrapFragment: function (e, t) {
        return e instanceof Ce ? He([], [e], t) : e;
      },
      makeVList: function (e, t) {
        ...
        return (
          2 === m.length && p.classes.push("vlist-t2"),
          (p.height = l),
          (p.depth = -a),
          p
        );
      ...
      makeOrd: function (e, t, r) {
        ...
        if (
          (55349 === s.charCodeAt(0) &&
            ([h, c] = (function (e, t) {
              ...
              if (120485 === r || 120486 === r) return [Te[0][2], Te[0][o]];
              if (120486 < r && r < 120782) return ["", ""];
              throw new n("Unsupported character: " + e);
            })(s, o)),
          h.length > 0)
        )
          return qe(s, h, o, t, i.concat(c));
        if (l) {
          let e, n;
          if ("boldsymbol" === l) {
            ...
            a
              ? ((e = De[l].fontName), (n = [l]))
              : ((e = Le(l, t.fontWeight, t.fontShape)),
        ...
        if ("mathord" === r)
          return qe(s, "Math-Italic", o, t, i.concat(["mathnormal"]));
        if ("textord" === r) {
    ...
    const Ke = function (e) {
      ...
      ot = function (e, t, r, n) {
        ...
        if (1 === e.length) {
          const r = e[0];
          "sizing" === r.type
            ? (s = t.havingSize(r.size))
            : "styling" === r.type && (s = t.havingStyle(rt[r.style]));
        }
        ...
        return (
          st(
            ...
            (e, t) => {
              const r = t.classes[0],
                n = e.classes[0];
              "mbin" === r && tt.includes(n)
                ? (t.classes[0] = "mord")
                : "mbin" === n && et.includes(r) && (e.classes[0] = "mord");
            },
            { node: i },
            a,
            l,
          ...
          st(
            ...
            (e, t) => {
              const r = lt(t),
                n = lt(e),
                o =
                  r && n ? (e.hasClass("mtight") ? Xe[r][n] : Ye[r][n]) : null;
      ...
      st = function (e, t, r, n, o) {
        ...
        for (; s < e.length; s++) {
          ...
          (a
            ? (r.node = n)
            : o && n.hasClass("newline") && (r.node = Qe(["leftmost"])),
            (r.insertAfter = ((t) => (r) => {
              (e.splice(t + 1, 0, r), s++);
            })(s)));
        }
      ...
      it = function (e) {
        return e instanceof Ce ||
          e instanceof _ ||
          (e instanceof W && e.hasClass("enclosing"))
          ? e
          : null;
      },
      at = function (e, t) {
    ...
    function mt(e, t) {
      const r = Qe(["base"], e, t),
        n = Qe(["strut"]);
      return (
        (n.style.height = P(r.height + r.depth)),
        r.depth && (n.style.verticalAlign = P(-r.depth)),
    ...
    function pt(e, t) {
      ...
      for (let e = 0; e < n.length; e++)
        if (
          ...
          n[e].hasClass("mbin") ||
            n[e].hasClass("mrel") ||
            n[e].hasClass("allowbreak"))
        ) {
          let r = !1;
          for (
            ;
            e < n.length - 1 &&
            n[e + 1].hasClass("mspace") &&
            !n[e + 1].hasClass("newline");
          )
            (e++, a.push(n[e]), n[e].hasClass("nobreak") && (r = !0));
          r || (s.push(mt(a, t)), (a = []));
        } else
          n[e].hasClass("newline") &&
            (a.pop(),
            a.length > 0 && (s.push(mt(a, t)), (a = [])),
            s.push(n[e]));
      (a.length > 0 && s.push(mt(a, t)),
        r
          ? ((i = mt(ot(r, t, !0))), (i.classes = ["tag"]), s.push(i))
          : o && s.push(o));
      const l = Qe(["katex-html"], s);
      if ((l.setAttribute("aria-hidden", "true"), i)) {
        const e = i.children[0];
        ((e.style.height = P(l.height + l.depth)),
          l.depth && (e.style.verticalAlign = P(-l.depth)));
      }
      return l;
    }
    function ut(e) {
    ...
    class dt {
      ...
      toNode() {
        ...
        for (let t = 0; t < this.children.length; t++)
          if (
            this.children[t] instanceof gt &&
            this.children[t + 1] instanceof gt
          ) {
      ...
      toMarkup() {
        ...
        for (const t in this.attributes)
          Object.prototype.hasOwnProperty.call(this.attributes, t) &&
            ...
            (e += '"'));
        (this.classes.length > 0 &&
          (e += ' class ="' + l.escape(F(this.classes)) + '"'),
          (e += ">"));
        for (let t = 0; t < this.children.length; t++)
          e += this.children[t].toMarkup();
    ...
    const bt = function (e, t, r) {
      ...
      xt = function (e, t) {
        ...
        oe[n][o] && oe[n][o].replace && (o = oe[n][o].replace);
        return C(o, Pe.fontMap[r].fontName, n) ? Pe.fontMap[r].variant : null;
      };
    function wt(e) {
      if (!e) return !1;
        ...
        for (let r = 0; r < e.length; r++) {
          ...
          if (s instanceof dt && o instanceof dt) {
            if (
              "mtext" === s.type &&
              "mtext" === o.type &&
              s.getAttribute("mathvariant") === o.getAttribute("mathvariant")
            ) {
            ...
            if ("mn" === s.type && wt(o))
              ...
              e instanceof dt &&
                "mn" === e.type &&
                ((e.children = [...o.children, ...e.children]), n.pop());
              ...
              if (
                ...
                e instanceof gt &&
                  e.text.length > 0 &&
                  ((e.text = e.text.slice(0, 1) + "\u0338" + e.text.slice(1)),
                  n.pop());
              }
            }
          }
    ...
    var Nt = function (e, t, r, n, o) {
        ...
        return ((s.height = i), (s.style.height = P(i)), s);
      },
      qt = function (e) {
        const t = new ft.MathNode("mo", [
          new ft.TextNode(Bt[e.replace(/^\\/, "")]),
        ]);
          ...
          if (["widehat", "widecheck", "widetilde", "utilde"].includes(n)) {
            ...
            if (s > 5)
              "widehat" === n || "widecheck" === n
                ? ((i = 420), (r = 2364), (l = 0.42), (a = n + "4"))
                : ((i = 312), (r = 2340), (l = 0.34), (a = "tilde4"));
            else {
              const e = [1, 1, 2, 2, 3, 3][s];
              "widehat" === n || "widecheck" === n
                ? ((r = [0, 1062, 2364, 2364, 2364][e]),
                  (i = [0, 239, 300, 360, 420][e]),
                  (l = [0, 0.24, 0.3, 0.3, 0.36, 0.42][e]),
                  (a = n + e))
                : ((r = [0, 600, 1033, 2339, 2340][e]),
                  (i = [0, 260, 286, 306, 312][e]),
                  (l = [0, 0.26, 0.286, 0.3, 0.306, 0.34][e]),
                  (a = "tilde" + e));
            }
            const h = new J(a),
              c = new K([h], {
    ...
    const Et = (e, t) => {
        ...
        let h,
          c = a
            ? s.height + s.depth
            : Math.min(s.height, t.fontMetrics().xHeight);
        if (n.isStretchy)
          ((h = It(n, t)),
            (h = Pe.makeVList(
              {
          ...
          let e, r;
          ("\\vec" === n.label
            ? ((e = Pe.staticSvg("vec", t)), (r = Pe.svgData.vec[1]))
            : ((e = Pe.makeOrd({ mode: n.mode, text: n.label }, t, "textord")),
              (e = ee(e)),
              (e.italic = 0),
              (r = e.width),
              a && (c += e.depth)),
            (h = Pe.makeSpan(["accent-body"], [e])));
      ...
      Lt = (e, t) => {
        const r = e.isStretchy
            ? qt(e.label)
            : new ft.MathNode("mo", [bt(e.label, e.mode)]),
      ...
      htmlBuilder(e, t) {
        ...
        (o.classes.push(s + "-arrow-pad"),
          e.below &&
            ...
            (i = Pe.wrapFragment(ct(e.below, n, t), t)),
            i.classes.push(s + "-arrow-pad")));
        const a = It(e, t),
          l = -t.fontMetrics().axisHeight + 0.5 * a.height;
        let h,
          c = -t.fontMetrics().axisHeight - 0.5 * a.height - 0.111;
        if (
          ((o.depth > 0.25 || "\\xleftequilibrium" === e.label) &&
            (c -= o.depth),
          i)
        ) {
          const e =
            -t.fontMetrics().axisHeight + i.height + 0.5 * a.height + 0.111;
          h = Pe.makeVList(
            {
              positionType: "individualShift",
              children: [
                { type: "elem", elem: o, shift: c },
                { type: "elem", elem: a, shift: l },
                { type: "elem", elem: i, shift: e },
              ],
            },
            t,
          );
    ...
    function Gt(e, t) {
      ...
      return (
        "minner" === e.mclass
          ? (r = new ft.MathNode("mpadded", n))
          : "mord" === e.mclass
            ? e.isCharacterBox
              ? ((r = n[0]), (r.type = "mi"))
              : (r = new ft.MathNode("mi", n))
            : (e.isCharacterBox
                ? ((r = n[0]), (r.type = "mo"))
                : (r = new ft.MathNode("mo", n)),
              "mbin" === e.mclass
    ...
    ($e({
      ...
      $e({
        ...
        mathmlBuilder(e, t) {
          ...
          return (
            n.setAttribute("style", "text-shadow: 0.02em 0.01em 0.04px"),
            n
          );
        },
      }));
    ...
    function Wt(e, t, r) {
      ...
      switch (n) {
        ...
        case "\\uparrow":
        case "\\downarrow": {
          const e = { type: "atom", text: n, mode: "math", family: "rel" },
            o = {
              type: "ordgroup",
              mode: "math",
              body: [
                r.callFunction("\\\\cdleft", [t[0]], []),
                r.callFunction("\\Big", [e], []),
      ...
      $e({
        ...
        handler(e, t) {
          ...
          return (
            ...
            { type: "textord", mode: r.mode, text: i }
          );
        },
      }));
    const _t = (e, t) => {
    ...
    ($e({
      ...
      $e({
        ...
        handler(e, t, r) {
          let { parser: n } = e;
          const o =
              "[" === n.gullet.future().text ? n.parseSizeGroup(!0) : null,
            s =
        ...
        htmlBuilder(e, t) {
          ...
          return (
            e.newLine &&
              ...
              e.size && (r.style.marginTop = P(V(e.size, t)))),
            r
          );
        },
        mathmlBuilder(e, t) {
          ...
          return (
            e.newLine &&
              ...
              e.size && r.setAttribute("height", P(V(e.size, t)))),
            r
          );
        },
      }));
      ...
      $e({
        ...
        handler(e) {
          ...
          return (
            ...
            t.gullet.macros.set(
              s,
              { tokens: h, numArgs: a, delimiters: l },
              r === $t[r],
            ),
    ...
    const Jt = function (e, t, r) {
        const n = C((oe.math[e] && oe.math[e].replace) || e, t, r);
        if (!n)
          throw new Error(
      ...
      tr = function (e, t, r, n, o, s) {
        const i = (function (e, t, r, n) {
          ...
          a = Qt(
            Pe.makeSpan(["delimsizing", "size" + t], [i], n),
            w.TEXT,
            n,
            s,
          );
      ...
      rr = function (e, t, r) {
        ...
        return {
          ...
          elem: Pe.makeSpan(
            ["delimsizinginner", n],
            [Pe.makeSpan([], [Pe.makeSymbol(e, t, r)])],
          ),
        };
      },
      nr = function (e, t, r) {
        const n = A["Size4-Regular"][e.charCodeAt(0)]
          ...
          o = new J(
            ...
            (function (e, t) {
              switch (e) {
                case "\u239c":
                  return (
                    "M291 0 H417 V" + t + " H291z M291 0 H417 V" + t + " H291z"
                  );
                case "\u2223":
                  return (
                    "M145 0 H188 V" + t + " H145z M145 0 H188 V" + t + " H145z"
                  );
                case "\u2225":
                  return (
                    "M145 0 H188 V" +
                ...
                case "\u239f":
                  return (
                    "M457 0 H583 V" + t + " H457z M457 0 H583 V" + t + " H457z"
                  );
                case "\u23a2":
                  return (
                    "M319 0 H403 V" + t + " H319z M319 0 H403 V" + t + " H319z"
                  );
                case "\u23a5":
                  return (
                    "M263 0 H347 V" + t + " H263z M263 0 H347 V" + t + " H263z"
                  );
                case "\u23aa":
                  return (
                    "M384 0 H504 V" + t + " H384z M384 0 H504 V" + t + " H384z"
                  );
                case "\u23d0":
                  return (
                    "M312 0 H355 V" + t + " H312z M312 0 H355 V" + t + " H312z"
                  );
                case "\u2016":
                  return (
                    "M257 0 H300 V" +
      ...
      ar = function (e, t, r, n, o, s) {
          ...
          : "\\Uparrow" === e
            ...
            : "\\downarrow" === e
              ...
              : "\\Downarrow" === e
                ? (i = l = "\u2016")
                : "\\updownarrow" === e
                  ? ((i = "\\uparrow"), (l = "\u23d0"), (h = "\\downarrow"))
                  : "\\Updownarrow" === e
                    ? ((i = "\\Uparrow"), (l = "\u2016"), (h = "\\Downarrow"))
                    : sr.includes(e)
                      ? ((l = "\u2223"), (c = "vert"), (m = 333))
                      : ir.includes(e)
                        ? ((l = "\u2225"), (c = "doublevert"), (m = 556))
                        : "[" === e || "\\lbrack" === e
                          ? ((i = "\u23a1"),
                            (l = "\u23a2"),
                            (h = "\u23a3"),
        ...
        const k = d + y + x,
          S = k + Math.max(0, Math.ceil((t - k) / (v * f))) * v * f;
        ...
        if (c.length > 0) {
          ...
          ((l.height = t / 1e3),
            (l.style.width = s),
            (l.style.height = i),
            A.push({ type: "elem", elem: l }));
        } else {
          if ((A.push(rr(h, p, o)), A.push(or), null === a)) {
            const e = S - d - y + 0.016;
            A.push(nr(l, e, n));
          } else {
            const e = (S - d - y - x) / 2 + 0.016;
            (A.push(nr(l, e, n)),
              A.push(or),
              A.push(rr(a, p, o)),
              A.push(or),
        ...
        const T = n.havingBaseStyle(w.TEXT),
          B = Pe.makeVList(
            { positionType: "bottom", positionData: z, children: A },
            T,
          );
        return Qt(Pe.makeSpan(["delimsizing", "mult"], [B], T), w.TEXT, n, s);
      },
      lr = 0.08,
      ...
      yr = function (e, t, r, n) {
        for (
          let o = Math.min(2, 3 - n.style.size);
          o < r.length && "stack" !== r[o].type;
          o++
        ) {
      ...
      xr = function (e, t, r, n, o, s) {
        ...
        ("<" === e || "\\lt" === e || "\u27e8" === e
          ? (e = "\\langle")
          : (">" !== e && "\\gt" !== e && "\u27e9" !== e) || (e = "\\rangle"),
          (i = pr.includes(e) ? dr : cr.includes(e) ? fr : gr));
        const a = yr(e, t, i, n);
        return "small" === a.type
          ...
          "small" === n.type
            ...
            : "large" === n.type
              ? ((c = 1080 * ur[n.size]),
                (h = (ur[n.size] + s) / o),
                (l = (ur[n.size] + s + lr) / o),
                (i = hr("sqrtSize" + n.size, l, c, s, t)),
                (i.style.minWidth = "1.02em"),
                (a = 1 / o))
              : ((l = e + s + lr),
                (h = e + s),
                (c = Math.floor(1e3 * e + s) + 80),
                (i = hr("sqrtTall", l, c, s, t)),
      ...
      sizedDelim: function (e, t, r, o, s) {
        if (
          ("<" === e || "\\lt" === e || "\u27e8" === e
            ? (e = "\\langle")
            : (">" !== e && "\\gt" !== e && "\u27e9" !== e) || (e = "\\rangle"),
          cr.includes(e) || pr.includes(e))
        )
          return tr(e, t, !1, r, o, s);
        if (mr.includes(e)) return ar(e, ur[t], !1, r, o, s);
    ...
    function Sr(e, t) {
      const r = Ot(e);
      if (r && kr.includes(r.text)) return r;
      throw new n(
        r
    ...
    ($e({
      ...
      htmlBuilder: (e, t) =>
        "." === e.delim
          ? Pe.makeSpan([e.mclass])
          : wr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
      mathmlBuilder: (e) => {
        const t = [];
        ...
        const n = P(wr.sizeToMaxHeight[e.size]);
      ...
      $e({
        ...
        htmlBuilder: (e, t) => {
          ...
          for (let e = 0; e < r.length; e++)
            r[e].isMiddle
              ? (a = !0)
              : ((s = Math.max(r[e].height, s)), (i = Math.max(r[e].depth, i)));
          if (
            ((s *= t.sizeMultiplier),
            (i *= t.sizeMultiplier),
            (n =
              "." === e.left
                ? ht(t, ["mopen"])
                : wr.leftRightDelim(e.left, s, i, t, e.mode, ["mopen"])),
            r.unshift(n),
            a)
          )
    ...
    const zr = (e, t) => {
        ...
        if ("sout" === n)
          ((o = Pe.makeSpan(["stretchy", "sout"])),
            (o.height = t.fontMetrics().defaultRuleThickness / s),
            (i = -0.5 * t.fontMetrics().xHeight));
        else if ("phase" === n) {
          const e = V({ number: 0.6, unit: "pt" }, t),
            n = V({ number: 0.35, unit: "ex" }, t);
          ...
          const l = Math.floor(1e3 * a * s),
            c =
              ...
              (h - 80) +
              " H400000z",
            m = new K([new J("phase", c)], {
              width: "400em",
              height: P(l / 1e3),
              viewBox: "0 0 400000 " + l,
              preserveAspectRatio: "xMinYMin slice",
            });
          ((o = Pe.makeSvgSpan(["hide-tail"], [m], t)),
            (o.style.height = P(a)),
            (i = r.depth + e + n));
        } else {
          /cancel/.test(n)
          ...
          let s = 0,
            ...
            h = 0;
          (/box/.test(n)
            ? ((h = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness)),
            ...
            : "angl" === n
              ? ((h = Math.max(
                ...
                (s = 4 * h),
                (l = Math.max(0, 0.25 - r.depth)))
              : ((s = a ? 0.2 : 0), (l = s)),
            (o = Nt(r, n, s, l, t)),
            /fbox|boxed|fcolorbox/.test(n)
              ? ((o.style.borderStyle = "solid"), (o.style.borderWidth = P(h)))
              : "angl" === n &&
                0.049 !== h &&
                ((o.style.borderTopWidth = P(h)),
                (o.style.borderRightWidth = P(h))),
            (i = r.depth + l),
            e.backgroundColor &&
              ((o.style.backgroundColor = e.backgroundColor),
          ...
          c = Pe.makeVList(
            {
              ...
              children: [
                { type: "elem", elem: r, shift: 0 },
                { type: "elem", elem: o, shift: i, wrapperClasses: e },
              ],
            },
            t,
          );
        ...
        return (
          /cancel/.test(n) && ((c.height = r.height), (c.depth = r.depth)),
          /cancel/.test(n) && !a
            ? Pe.makeSpan(["mord", "cancel-lap"], [c], t)
            : Pe.makeSpan(["mord"], [c], t)
        );
      },
      Ar = (e, t) => {
        let r = 0;
        const n = new ft.MathNode(
        ...
        switch (e.label) {
          ...
          case "\\colorbox":
            if (
              ...
              n.setAttribute(
                "style",
                "border: " + r + "em solid " + String(e.borderColor),
              );
            }
            break;
          case "\\xcancel":
        ...
        return (
          e.backgroundColor &&
            n.setAttribute("mathbackground", e.backgroundColor),
          n
        );
      };
    ($e({
      ...
      static range(e, t) {
        return t
          ? e && e.loc && t.loc && e.loc.lexer === t.loc.lexer
            ? new qr(e.loc.lexer, e.loc.start, t.loc.end)
            : null
          : e && e.loc;
      }
    }
    ...
    function Rr(e) {
      ...
      for (
        "\\relax" === r &&
        (e.consume(), e.consumeSpaces(), (r = e.fetch().text));
        "\\hline" === r || "\\hdashline" === r;
      )
        (e.consume(),
          t.push("\\hdashline" === r),
      ...
      function w() {
        y &&
          (e.gullet.macros.get("\\df@tag")
            ? (y.push(e.subparse([new Ir("\\df@tag")])),
              e.gullet.macros.set("\\df@tag", void 0, !0))
            : y.push(Boolean(h) && "1" === e.gullet.macros.get("\\@eqnsw")));
      }
      for (x(), b.push(Rr(e)); ; ) {
        let t = e.parseExpression(!1, c ? "\\end" : "\\\\");
        (e.gullet.endGroup(),
          e.gullet.beginGroup(),
          (t = { type: "ordgroup", mode: e.mode, body: t }),
          r && (t = { type: "styling", mode: e.mode, style: r, body: [t] }),
          d.push(t));
    ...
    const Dr = function (e, t) {
        ...
        if (e.colSeparationType && "small" === e.colSeparationType) {
          u =
            (t.havingStyle(w.SCRIPT).sizeMultiplier / t.sizeMultiplier) *
            0.2778;
        }
        const d =
            "CD" === e.colSeparationType
              ? V({ number: 3, unit: "ex" }, t)
              : 12 * p,
          g = 3 * p,
          f = e.arraystretch * d,
          b = 0.7 * f,
        ...
        function v(e) {
          for (let t = 0; t < e.length; ++t)
            (t > 0 && (x += 0.25), c.push({ pos: x, isDashed: e[t] }));
        }
        ...
        if (e.tags && e.tags.some((e) => e))
          for (r = 0; r < s; ++r) {
            ...
            ((i =
              !0 === s
                ? Pe.makeSpan(["eqn-num"], [], t)
                : !1 === s
                  ? Pe.makeSpan([], [], t)
                  : Pe.makeSpan([], ot(s, t, !0), t)),
              (i.depth = n.depth),
              (i.height = n.height),
              T.push({ type: "elem", elem: i, shift: o }));
          }
        for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
          ...
          for (; "separator" === c.type; ) {
            if (
              (p ||
                ((z = Pe.makeSpan(["arraycolsep"], [])),
                (z.style.width = P(t.fontMetrics().doubleRuleSep)),
                M.push(z)),
              ...
              throw new n("Invalid separator type: " + c.separator);
            {
              ...
              ((r.style.height = P(x)),
                (r.style.borderRightWidth = P(m)),
                (r.style.borderRightStyle = e),
                (r.style.margin = "0 " + P(-m / 2)));
              const n = x - k;
          ...
          for (r = 0; r < s; ++r) {
            ...
            ((t.depth = e.depth),
              (t.height = e.height),
              d.push({ type: "elem", elem: t, shift: n }));
          }
          ((d = Pe.makeVList(
            { positionType: "individualShift", children: d },
            t,
          )),
            (d = Pe.makeSpan(["col-align-" + (c.align || "c")], [d])),
            M.push(d),
            (o < a - 1 || e.hskipBeforeAndAfter) &&
              ((i = l.deflt(c.postgap, u)),
              0 !== i &&
                ((z = Pe.makeSpan(["arraycolsep"], [])),
                (z.style.width = P(i)),
                M.push(z))));
        ...
        if (((h = Pe.makeSpan(["mtable"], M)), c.length > 0)) {
          ...
          for (; c.length > 0; ) {
            const t = c.pop(),
              o = t.pos - k;
            t.isDashed
              ? n.push({ type: "elem", elem: r, shift: o })
              : n.push({ type: "elem", elem: e, shift: o });
          }
      ...
      Pr = function (e, t) {
        ...
        for (let s = 0; s < e.body.length; s++) {
          ...
          (e.tags &&
            e.tags[s] &&
            (a.unshift(n), a.push(n), e.leqno ? a.unshift(o) : a.push(o)),
            r.push(new ft.MathNode("mtr", a)));
        }
        ...
        if (e.cols && e.cols.length > 0) {
          ...
          let r = "",
            ...
            o = 0,
            i = t.length;
          ("separator" === t[0].type && ((a += "top "), (o = 1)),
            "separator" === t[t.length - 1].type &&
              ((a += "bottom "), (i -= 1)));
          for (let e = o; e < i; e++)
            "align" === t[e].type
              ? ((l += Vr[t[e].align]), n && (r += "none "), (n = !0))
              : "separator" === t[e].type &&
                n &&
                ((r += "|" === t[e].separator ? "solid " : "dashed "),
                (n = !1));
        ...
        if ("align" === e.colSeparationType) {
          ...
          "alignat" === e.colSeparationType || "gather" === e.colSeparationType
            ? s.setAttribute("columnspacing", "0em")
            : "small" === e.colSeparationType
              ? s.setAttribute("columnspacing", "0.2778em")
              : "CD" === e.colSeparationType
                ? s.setAttribute("columnspacing", "0.5em")
                : s.setAttribute("columnspacing", "1em");
        let h = "";
        ...
        return (
          /[sd]/.test(h) && s.setAttribute("rowlines", h.trim()),
          "" !== a &&
            ((s = new ft.MathNode("menclose", [s])),
            s.setAttribute("notation", a.trim())),
          e.arraystretch &&
            e.arraystretch < 1 &&
            ((s = new ft.MathNode("mstyle", [s])),
      ...
      Fr = function (e, t) {
        ...
        i.body.forEach(function (e) {
          ...
          if (c) l < e.length && (l = e.length);
            ...
            if (a < t)
              throw new n(
                "Too many math in a row: expected " + a + ", but got " + t,
                e[0],
              );
          }
        });
        for (let e = 0; e < l; ++e) {
          let t = "r",
            n = 0;
          (e % 2 == 1 ? (t = "l") : e > 0 && c && (n = 1),
            (r[e] = { type: "align", align: t, pregap: n, postgap: 0 }));
        }
    ...
    (Br({
      ...
      props: { numArgs: 1 },
      handler(e, t) {
        const r = (Ot(t[0]) ? [t[0]] : Rt(t[0], "ordgroup").body).map(
            function (e) {
              const t = Ht(e).text;
      ...
      Br({
        ...
        props: { numArgs: 0 },
        handler(e) {
          const t = Er(e.parser, { arraystretch: 0.5 }, "script");
      ...
      Br({
        ...
        handler(e, t) {
          ...
          let o = { cols: r, hskipBeforeAndAfter: !1, arraystretch: 0.5 };
          if (
            ((o = Er(e.parser, o, "script")),
      ...
      Br({
        ...
        props: { numArgs: 0 },
        handler(e) {
          ["gather", "gather*"].includes(e.envName) && Hr(e);
          const t = {
    ...
    $e({
      ...
      handler(e, t) {
        ...
        if ("\\begin" === o) {
          ...
          if (c.name !== i)
            throw new n(
              "Mismatch: \\begin{" + i + "} matched by \\end{" + c.name + "}",
              h,
            );
          return l;
        }
    ...
    ($e({
      ...
      handler: (e, t) => {
        ...
        return (
          s in Xr && (s = Xr[s]),
          { type: "font", mode: r.mode, font: s.slice(1), body: o }
        );
      },
      htmlBuilder: Ur,
      mathmlBuilder: Yr,
    ...
    const Wr = (e, t) => {
        ...
        return (
          "display" === e
            ...
            : "text" === e && r.size === w.DISPLAY.size
              ? (r = w.TEXT)
              : "script" === e
                ? (r = w.SCRIPT)
                : "scriptscript" === e && (r = w.SCRIPTSCRIPT),
          r
        );
      },
      _r = (e, t) => {
        ...
        if (
          (e.hasBarLine
            ? (e.barSize
                ? ((h = V(e.barSize, t)),
                  (l = Pe.makeLineSpan("frac-line", t, h)))
                : (l = Pe.makeLineSpan("frac-line", t)),
              (h = l.height),
              (c = l.height))
            : ((l = null), (h = 0), (c = t.fontMetrics().defaultRuleThickness)),
          r.size === w.DISPLAY.size || "display" === e.size
            ? ((m = t.fontMetrics().num1),
              (p = h > 0 ? 3 * c : 7 * c),
              (u = t.fontMetrics().denom1))
            : (h > 0
                ? ((m = t.fontMetrics().num2), (p = c))
                : ((m = t.fontMetrics().num3), (p = 3 * c)),
              (u = t.fontMetrics().denom2)),
          l)
        ) {
          const e = t.fontMetrics().axisHeight;
          (m - i.depth - (e + 0.5 * h) < p &&
            (m += p - (m - i.depth - (e + 0.5 * h))),
            e - 0.5 * h - (a.height - u) < p &&
              (u += p - (e - 0.5 * h - (a.height - u))));
          const r = -(e - 0.5 * h);
          d = Pe.makeVList(
            {
              positionType: "individualShift",
        ...
        return (
          ...
          (g =
            r.size === w.DISPLAY.size
              ...
              : r.size === w.SCRIPTSCRIPT.size
                ? t.havingStyle(w.SCRIPT).fontMetrics().delim2
          ...
          Pe.makeSpan(
            ["mord"].concat(s.sizingClasses(t)),
            [f, Pe.makeSpan(["mfrac"], [d]), b],
            t,
          )
        );
      },
      jr = (e, t) => {
        ...
        if (null != e.leftDelim || null != e.rightDelim) {
          const t = [];
          if (null != e.leftDelim) {
            const r = new ft.MathNode("mo", [
              new ft.TextNode(e.leftDelim.replace("\\", "")),
            ]);
            (r.setAttribute("fence", "true"), t.push(r));
          }
          if ((t.push(r), null != e.rightDelim)) {
            const r = new ft.MathNode("mo", [
              new ft.TextNode(e.rightDelim.replace("\\", "")),
            ]);
            (r.setAttribute("fence", "true"), t.push(r));
          }
          return yt(t);
    ...
    const Kr = (e, t) => {
      ...
      "supsub" === e.type
        ? ((n = e.sup
            ? ct(e.sup, t.havingStyle(r.sup()), t)
            : ct(e.sub, t.havingStyle(r.sub()), t)),
          (o = Rt(e.base, "horizBrace")))
        : (o = Rt(e, "horizBrace"));
      ...
      if (
        ...
        a = o.isOver
          ...
          : Pe.makeVList(
              {
                positionType: "bottom",
                positionData: e.depth + 0.2 + n.height + n.depth,
                children: [
                  { type: "elem", elem: n },
                  { type: "kern", size: 0.2 },
                  { type: "elem", elem: e },
    ...
    ($e({
      ...
      mathmlBuilder: (e, t) => {
        const r = qt(e.label);
        return new ft.MathNode(e.isOver ? "mover" : "munder", [
          St(e.base, t),
          r,
        ]);
      },
      ...
      $e({
        ...
        handler: (e, t) => {
          ...
          return r.settings.isTrusted({ command: "\\href", url: o })
            ? { type: "href", mode: r.mode, href: o, body: Je(n) }
        ...
        mathmlBuilder: (e, t) => {
          let r = kt(e.body, t);
          return (
            r instanceof dt || (r = new dt("mrow", [r])),
      ...
      $e({
        ...
        handler: (e, t) => {
          ...
          for (let e = 0; e < n.length; e++) {
            let t = n[e];
            ("~" === t && (t = "\\textasciitilde"),
              o.push({ type: "textord", mode: "text", text: t }));
          }
      ...
      $e({
        ...
        handler: (e, t) => {
          ...
          switch (o) {
            ...
            case "\\htmlData": {
              ...
              for (let t = 0; t < e.length; t++) {
                ...
                if (o < 0)
                  throw new n(
                    "\\htmlData key/value '" + r + "' missing equals sign",
                  );
                const s = r.slice(0, o),
                  i = r.slice(o + 1);
                h["data-" + s.trim()] = i;
          ...
          return r.settings.isTrusted(l)
            ? { type: "html", mode: r.mode, attributes: h, body: Je(a) }
        ...
        htmlBuilder: (e, t) => {
          const r = ot(e.body, t, !1),
            n = ["enclosing"];
          e.attributes.class &&
            n.push(...e.attributes.class.trim().split(/\s+/));
          const o = Pe.makeSpan(n, r, t);
          for (const t in e.attributes)
            "class" !== t &&
              e.attributes.hasOwnProperty(t) &&
    ...
    ($e({
      ...
      handler: (e, t, r) => {
        ...
        return (
          ...
          o.settings.isTrusted({ command: "\\includegraphics", url: h })
            ? {
                type: "includegraphics",
                mode: o.mode,
                alt: l,
      ...
      htmlBuilder: (e, t) => {
        const r = V(e.height, t);
        let n = 0;
        e.totalheight.number > 0 && (n = V(e.totalheight, t) - r);
        let o = 0;
        e.width.number > 0 && (o = V(e.width, t));
        const s = { height: P(r + n) };
        (o > 0 && (s.width = P(o)), n > 0 && (s.verticalAlign = P(-n)));
        const i = new j(e.src, e.alt, s);
        return ((i.height = r), (i.depth = n), i);
      },
      mathmlBuilder: (e, t) => {
        const r = new ft.MathNode("mglyph", []);
        r.setAttribute("alt", e.alt);
        const n = V(e.height, t);
        let o = 0;
        if (
          (e.totalheight.number > 0 &&
            ((o = V(e.totalheight, t) - n), r.setAttribute("valign", P(-o))),
          r.setAttribute("height", P(n + o)),
          e.width.number > 0)
        ) {
          const n = V(e.width, t);
      ...
      $e({
        ...
        htmlBuilder: (e, t) => {
          let r;
          "clap" === e.alignment
            ? ((r = Pe.makeSpan([], [ct(e.body, t)])),
              (r = Pe.makeSpan(["inner"], [r], t)))
            : (r = Pe.makeSpan(["inner"], [ct(e.body, t)]));
          const n = Pe.makeSpan(["fix"], []);
          let o = Pe.makeSpan([e.alignment], [r, n], t);
          const s = Pe.makeSpan(["strut"]);
          return (
            (s.style.height = P(o.height + o.depth)),
            o.depth && (s.style.verticalAlign = P(-o.depth)),
            o.children.unshift(s),
            (o = Pe.makeSpan(["thinbox"], [o], t)),
            Pe.makeSpan(["mord", "vbox"], [o], t)
          );
        },
        mathmlBuilder: (e, t) => {
      ...
      $e({
        ...
        handler(e, t) {
          ...
          return (
            n.expect(s),
            n.switchMode(o),
            { type: "styling", mode: n.mode, style: "text", body: i }
          );
        },
      }),
      $e({
    ...
    const en = (e, t, r, n, o, s, i) => {
        ...
        if (t) {
          ...
          c = {
            ...
            kern: Math.max(
              ...
              n.fontMetrics().bigOpSpacing3 - e.depth,
            ),
          };
        }
        if (r) {
          ...
          h = {
            ...
            kern: Math.max(
              ...
              n.fontMetrics().bigOpSpacing4 - e.height,
            ),
          };
        }
        if (c && h) {
          ...
          m = Pe.makeVList(
            {
              ...
              children: [
                ...
                { type: "elem", elem: h.elem, marginLeft: P(-s) },
                { type: "kern", size: h.kern },
                { type: "elem", elem: e },
                { type: "kern", size: c.kern },
                { type: "elem", elem: c.elem, marginLeft: P(s) },
                { type: "kern", size: n.fontMetrics().bigOpSpacing5 },
              ],
            },
            n,
      ...
      rn = (e, t) => {
        let r,
          ...
          s = !1;
        "supsub" === e.type
          ? ((r = e.sup), (n = e.sub), (o = Rt(e.base, "op")), (s = !0))
          : (o = Rt(e, "op"));
        const i = t.style;
        let a,
          l = !1;
        if (
          (i.size === w.DISPLAY.size &&
            o.symbol &&
            !tn.includes(o.name) &&
            (l = !0),
          o.symbol)
          ...
          let r = "";
          if (
            (("\\oiint" !== o.name && "\\oiiint" !== o.name) ||
              ((r = o.name.slice(1)),
              (o.name = "oiint" === r ? "\\iint" : "\\iiint")),
            (a = Pe.makeSymbol(o.name, e, "math", t, [
              "mop",
              "op-symbol",
              l ? "large-op" : "small-op",
            ])),
            ...
            const e = a.italic,
              n = Pe.staticSvg(r + "Size" + (l ? "2" : "1"), t);
            ((a = Pe.makeVList(
              {
                positionType: "individualShift",
                children: [
                  { type: "elem", elem: a, shift: 0 },
                  { type: "elem", elem: n, shift: l ? 0.08 : 0 },
                ],
              },
              t,
            )),
          ...
          1 === e.length && e[0] instanceof Z
            ? ((a = e[0]), (a.classes[0] = "mop"))
        ...
        let h = 0,
          c = 0;
        return (
          (a instanceof Z || "\\oiint" === o.name || "\\oiiint" === o.name) &&
            !o.suppressBaseShift &&
            ((h = (a.height - a.depth) / 2 - t.fontMetrics().axisHeight),
            (c = a.italic)),
          s
            ? en(a, r, n, t, i, c, h)
            : (h && ((a.style.position = "relative"), (a.style.top = P(h))), a)
        );
      },
      nn = (e, t) => {
        let r;
        if (e.symbol)
          ((r = new dt("mo", [bt(e.name, e.mode)])),
            tn.includes(e.name) && r.setAttribute("largeop", "false"));
    ...
    function ln(e, t, r) {
      ...
      for (let e = 0; e < n.length; e++) {
        ...
        (s < 0
          ? Array.prototype.push.apply(n[e].classes, t.sizingClasses(r))
          : n[e].classes[s + 1] === "reset-size" + t.size &&
            (n[e].classes[s + 1] = "reset-size" + r.size),
          (n[e].height *= o),
          (n[e].depth *= o));
      }
      return Pe.makeFragment(n);
    ...
    ($e({
      ...
      mathmlBuilder: (e, t) => {
          ...
          if (t instanceof ft.SpaceNode);
            ...
            switch (t.type) {
              ...
              case "mo": {
                ...
                1 === t.children.length && e instanceof ft.TextNode
                  ? (e.text = e.text
                      .replace(/\u2212/, "-")
                      .replace(/\u2217/, "*"))
                  : (n = !1);
        ...
        return e.parentIsSupSub
          ? new ft.MathNode("mrow", [o, s])
          : ft.newDocumentFragment([o, s]);
      },
    }),
      Nr("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"),
      Ze({
        type: "ordgroup",
        htmlBuilder(e, t) {
          return e.semisimple
            ? Pe.makeFragment(ot(e.body, t, !1))
            : Pe.makeSpan(["mord"], ot(e.body, t, !0), t);
        },
        mathmlBuilder(e, t) {
        ...
        htmlBuilder: (e, t) => {
          ...
          if (((r.height = 0), (r.depth = 0), r.children))
            for (let e = 0; e < r.children.length; e++)
              ((r.children[e].height = 0), (r.children[e].depth = 0));
          return (
            (r = Pe.makeVList(
              {
                positionType: "firstBaseline",
      ...
      $e({
        ...
        htmlBuilder(e, t) {
          const r = Pe.makeSpan(["mord", "rule"], [], t),
            n = V(e.width, t),
            o = V(e.height, t),
            s = e.shift ? V(e.shift, t) : 0;
          return (
            (r.style.borderRightWidth = P(n)),
            (r.style.borderTopWidth = P(o)),
            (r.style.bottom = P(s)),
            (r.width = n),
            (r.height = o + s),
            (r.depth = -s),
        ...
        mathmlBuilder(e, t) {
          const r = V(e.width, t),
            n = V(e.height, t),
            o = e.shift ? V(e.shift, t) : 0,
            s = (t.color && t.getColor()) || "black",
            i = new ft.MathNode("mspace");
          (i.setAttribute("mathbackground", s),
            i.setAttribute("width", P(r)),
            i.setAttribute("height", P(n)));
          const a = new ft.MathNode("mpadded", [i]);
          return (
            o >= 0
              ? a.setAttribute("height", P(o))
              : (a.setAttribute("height", P(o)),
                a.setAttribute("depth", P(-o))),
            a.setAttribute("voffset", P(o)),
            a
          );
        },
      }));
    ...
    ($e({
      ...
      mathmlBuilder: (e, t) => {
        ...
        return (o.setAttribute("mathsize", P(r.sizeMultiplier)), o);
      },
    }),
      $e({
        type: "smash",
      ...
      $e({
        ...
        mathmlBuilder(e, t) {
          ...
          return n
            ? new ft.MathNode("mroot", [St(r, t), St(n, t)])
            : new ft.MathNode("msqrt", [St(r, t)]);
        },
      }));
    const cn = {
      display: w.DISPLAY,
    ...
    $e({
      ...
      mathmlBuilder(e, t) {
        ...
        return (
          s.setAttribute("scriptlevel", i[0]),
    ...
    (Ze({
      ...
      htmlBuilder(e, t) {
        const r = (function (e, t) {
          ...
          if (r)
            return "op" === r.type
              ? r.limits &&
                (t.style.size === w.DISPLAY.size || r.alwaysHandleSupSub)
                ? rn
                : null
              : "operatorname" === r.type
                ? r.alwaysHandleSupSub &&
                  (t.style.size === w.DISPLAY.size || r.limits)
                  ? an
                  : null
                : "accent" === r.type
                  ? l.isCharacterBox(r.base)
                    ? Et
                    : null
        ...
        if (o) {
          ...
          ((a = ct(o, e, t)),
            u ||
              (m =
                i.height -
                (e.fontMetrics().supDrop * e.sizeMultiplier) /
                  t.sizeMultiplier));
        }
        if (s) {
          ...
          ((h = ct(s, e, t)),
            u ||
              (p =
                i.depth +
                (e.fontMetrics().subDrop * e.sizeMultiplier) /
                  t.sizeMultiplier));
        }
        let d;
        ...
        if (a && h) {
          ((m = Math.max(m, d, a.depth + 0.25 * c.xHeight)),
            (p = Math.max(p, c.sub2)));
          const e = 4 * c.defaultRuleThickness;
          if (m - a.depth - (h.height - p) < e) {
            p = e - (m - a.depth) + h.height;
            const t = 0.8 * c.xHeight - (m - a.depth);
            t > 0 && ((m += t), (p -= t));
          }
          const r = [
            { type: "elem", elem: h, shift: p, marginRight: f, marginLeft: y },
            { type: "elem", elem: a, shift: -m, marginRight: f },
          ];
          ...
          b = Pe.makeVList(
            { positionType: "shift", positionData: p, children: e },
            t,
          );
        } else {
      ...
      mathmlBuilder(e, t) {
        ...
        (e.base &&
          ...
          ((n = !!e.sup),
          n === e.base.isOver && ((o = !0), (r = e.base.isOver))),
          !e.base ||
            ("op" !== e.base.type && "operatorname" !== e.base.type) ||
            (e.base.parentIsSupSub = !0));
        const s = [St(e.base, t)];
        let i;
        if ((e.sub && s.push(St(e.sub, t)), e.sup && s.push(St(e.sup, t)), o))
          i = r ? "mover" : "munder";
        else if (e.sub)
          if (e.sup) {
            const r = e.base;
            i =
              (r && "op" === r.type && r.limits && t.style === w.DISPLAY) ||
              (r &&
                "operatorname" === r.type &&
                r.alwaysHandleSupSub &&
                (t.style === w.DISPLAY || r.limits))
                ? "munderover"
                : "msubsup";
          } else {
            const r = e.base;
            i =
              (r &&
                "op" === r.type &&
                r.limits &&
                (t.style === w.DISPLAY || r.alwaysHandleSupSub)) ||
              (r &&
                "operatorname" === r.type &&
                r.alwaysHandleSupSub &&
                (r.limits || t.style === w.DISPLAY))
                ? "munder"
                : "msub";
          }
        else {
      ...
      Ze({
        ...
        mathmlBuilder(e, t) {
          ...
          return (
            (o =
              "text" === e.mode
                ? new ft.MathNode("mtext", [r])
                : /[0-9]/.test(e.text)
                  ? new ft.MathNode("mn", [r])
                  : "\\prime" === e.text
                    ? new ft.MathNode("mo", [r])
                    : new ft.MathNode("mi", [r])),
            n !== mn[o.type] && o.setAttribute("mathvariant", n),
            o
          );
        },
      }));
    ...
    Ze({
      ...
      htmlBuilder(e, t) {
        ...
        if (pn.hasOwnProperty(e.text))
          return Pe.makeSpan(["mspace", pn[e.text]], [], t);
    ...
    Ze({
      type: "tag",
      mathmlBuilder(e, t) {
        const r = new ft.MathNode("mtable", [
          new ft.MathNode("mtr", [
            dn(),
            new ft.MathNode("mtd", [kt(e.body, t)]),
            dn(),
            new ft.MathNode("mtd", [kt(e.tag, t)]),
          ]),
        ]);
    ...
    const gn = {
      ...
      fn = { "\\textbf": "textbf", "\\textmd": "textmd" },
      bn = { "\\textit": "textit", "\\textup": "textup" },
      yn = (e, t) => {
        const r = e.font;
        return r
          ? gn[r]
            ? t.withTextFontFamily(gn[r])
            : fn[r]
              ? t.withTextFontWeight(fn[r])
              : "\\emph" === r
                ? "textit" === t.fontShape
                  ? t.withTextFontShape("textup")
                  : t.withTextFontShape("textit")
                : t.withTextFontShape(bn[r])
          : t;
      };
    ($e({
      type: "text",
      ...
      $e({
        ...
        htmlBuilder(e, t) {
          ...
          for (let t = 0; t < r.length; t++) {
            ...
            ("~" === s && (s = "\\textasciitilde"),
              n.push(
                Pe.makeSymbol(s, "Typewriter-Regular", e.mode, o, [
                  "mord",
                  "texttt",
                ]),
              ));
    ...
    class An {
      constructor(e, t) {
        ((this.input = void 0),
          ...
          (this.input = e),
          (this.settings = t),
          (this.tokenRegex = new RegExp(zn, "g")),
          (this.catcodes = { "%": 14, "~": 13 }));
      }
      setCatcode(e, t) {
        this.catcodes[e] = t;
    ...
    (Nr("\\noexpand", function (e) {
      ...
      Nr("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"),
      Nr("\\TextOrMath", function (e) {
    ...
    (Nr("\\newcommand", (e) => Nn(e, !1, !0, !1)),
      Nr("\\renewcommand", (e) => Nn(e, !0, !1, !1)),
      Nr("\\providecommand", (e) => Nn(e, !0, !0, !0)),
      Nr("\\message", (e) => {
      ...
      Nr("\\show", (e) => {
        const t = e.popToken(),
          r = t.text;
        return (
          console.log(t, e.macros.get(r), wn[r], oe.math[r], oe.text[r]),
          ""
        );
      }),
      Nr("\\bgroup", "{"),
      ...
      Nr("\\aa", "\\r a"),
      Nr("\\AA", "\\r A"),
      Nr("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`\xa9}"),
      Nr(
        "\\copyright",
      ...
      Nr("\\Bbbk", "\\Bbb{k}"),
      Nr("\xb7", "\\cdotp"),
      Nr("\\llap", "\\mathllap{\\textrm{#1}}"),
      Nr("\\rlap", "\\mathrlap{\\textrm{#1}}"),
      Nr("\\clap", "\\mathclap{\\textrm{#1}}"),
      Nr("\\mathstrut", "\\vphantom{(}"),
      Nr("\\underbar", "\\underline{\\text{#1}}"),
      ...
      Nr("\u231f", "\\lrcorner"),
      Nr("\xa9", "\\copyright"),
      Nr("\xae", "\\textregistered"),
      Nr("\ufe0f", "\\textregistered"),
      Nr("\\ulcorner", '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
      Nr("\\urcorner", '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
      Nr("\\llcorner", '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
      Nr("\\lrcorner", '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      Nr("\\vdots", "{\\varvdots\\rule{0pt}{15pt}}"),
      Nr("\u22ee", "\\vdots"),
      Nr("\\varGamma", "\\mathit{\\Gamma}"),
      Nr("\\varDelta", "\\mathit{\\Delta}"),
      Nr("\\varTheta", "\\mathit{\\Theta}"),
      Nr("\\varLambda", "\\mathit{\\Lambda}"),
      Nr("\\varXi", "\\mathit{\\Xi}"),
      Nr("\\varPi", "\\mathit{\\Pi}"),
      Nr("\\varSigma", "\\mathit{\\Sigma}"),
      Nr("\\varUpsilon", "\\mathit{\\Upsilon}"),
      Nr("\\varPhi", "\\mathit{\\Phi}"),
      Nr("\\varPsi", "\\mathit{\\Psi}"),
      Nr("\\varOmega", "\\mathit{\\Omega}"),
      Nr("\\substack", "\\begin{subarray}{c}#1\\end{subarray}"),
      Nr(
        "\\colon",
        "\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu\\relax",
      ),
      Nr("\\boxed", "\\fbox{$\\displaystyle{#1}$}"),
      Nr("\\iff", "\\DOTSB\\;\\Longleftrightarrow\\;"),
      Nr("\\implies", "\\DOTSB\\;\\Longrightarrow\\;"),
      Nr("\\impliedby", "\\DOTSB\\;\\Longleftarrow\\;"),
      Nr("\\dddot", "{\\overset{\\raisebox{-0.1ex}{\\normalsize ...}}{#1}}"),
      Nr("\\ddddot", "{\\overset{\\raisebox{-0.1ex}{\\normalsize ....}}{#1}}"));
    const qn = {
      ",": "\\dotsc",
      "\\not": "\\dotsb",
      "+": "\\dotsb",
    ...
    Nr("\\dots", function (e) {
      ...
      return (
        r in qn
          ? (t = qn[r])
          : ("\\not" === r.slice(0, 4) ||
              (r in oe.math && ["bin", "rel"].includes(oe.math[r].group))) &&
            (t = "\\dotsb"),
        t
      );
    });
    ...
    (Nr("\\dotso", function (e) {
      ...
      Nr("\\DOTSB", "\\relax"),
      Nr("\\DOTSX", "\\relax"),
      Nr("\\tmspace", "\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax"),
      Nr("\\,", "\\tmspace+{3mu}{.1667em}"),
      Nr("\\thinspace", "\\,"),
      Nr("\\>", "\\mskip{4mu}"),
      Nr("\\:", "\\tmspace+{4mu}{.2222em}"),
      Nr("\\medspace", "\\:"),
      Nr("\\;", "\\tmspace+{5mu}{.2777em}"),
      Nr("\\thickspace", "\\;"),
      Nr("\\!", "\\tmspace-{3mu}{.1667em}"),
      Nr("\\negthinspace", "\\!"),
      ...
      Nr("\\enspace", "\\kern.5em "),
      Nr("\\enskip", "\\hskip.5em\\relax"),
      Nr("\\quad", "\\hskip1em\\relax"),
      Nr("\\qquad", "\\hskip2em\\relax"),
      Nr("\\tag", "\\@ifstar\\tag@literal\\tag@paren"),
      Nr("\\tag@paren", "\\tag@literal{({#1})}"),
      Nr("\\tag@literal", (e) => {
    ...
    const Rn = P(
      A["Main-Regular"]["T".charCodeAt(0)][1] -
        0.7 * A["Main-Regular"]["A".charCodeAt(0)][1],
    );
    (Nr(
      "\\LaTeX",
      ...
      Nr("\\hspace", "\\@ifstar\\@hspacer\\@hspace"),
      Nr("\\@hspace", "\\hskip #1\\relax"),
      Nr("\\@hspacer", "\\rule{0pt}{0pt}\\hskip #1\\relax"),
      Nr("\\ordinarycolon", ":"),
      Nr("\\vcentcolon", "\\mathrel{\\mathop\\ordinarycolon}"),
      Nr(
        "\\dblcolon",
      ...
      Nr("\u2a74", "\\Coloneqq"),
      Nr("\\ratio", "\\vcentcolon"),
      Nr("\\coloncolon", "\\dblcolon"),
      Nr("\\colonequals", "\\coloneqq"),
      Nr("\\coloncolonequals", "\\Coloneqq"),
      Nr("\\equalscolon", "\\eqqcolon"),
      Nr("\\equalscoloncolon", "\\Eqqcolon"),
      Nr("\\colonminus", "\\coloneq"),
      Nr("\\coloncolonminus", "\\Coloneq"),
      Nr("\\minuscolon", "\\eqcolon"),
      Nr("\\minuscoloncolon", "\\Eqcolon"),
      Nr("\\coloncolonapprox", "\\Colonapprox"),
      Nr("\\coloncolonsim", "\\Colonsim"),
      Nr("\\simcolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
      Nr(
        "\\simcoloncolon",
      ...
      Nr("\\notni", "\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}"),
      Nr("\\limsup", "\\DOTSB\\operatorname*{lim\\,sup}"),
      Nr("\\liminf", "\\DOTSB\\operatorname*{lim\\,inf}"),
      Nr("\\injlim", "\\DOTSB\\operatorname*{inj\\,lim}"),
      Nr("\\projlim", "\\DOTSB\\operatorname*{proj\\,lim}"),
      Nr("\\varlimsup", "\\DOTSB\\operatorname*{\\overline{lim}}"),
      Nr("\\varliminf", "\\DOTSB\\operatorname*{\\underline{lim}}"),
      Nr("\\varinjlim", "\\DOTSB\\operatorname*{\\underrightarrow{lim}}"),
      Nr("\\varprojlim", "\\DOTSB\\operatorname*{\\underleftarrow{lim}}"),
      Nr("\\gvertneqq", "\\html@mathml{\\@gvertneqq}{\u2269}"),
      Nr("\\lvertneqq", "\\html@mathml{\\@lvertneqq}{\u2268}"),
      ...
      Nr("\\varsubsetneq", "\\html@mathml{\\@varsubsetneq}{\u228a}"),
      Nr("\\varsubsetneqq", "\\html@mathml{\\@varsubsetneqq}{\u2acb}"),
      Nr("\\varsupsetneq", "\\html@mathml{\\@varsupsetneq}{\u228b}"),
      Nr("\\varsupsetneqq", "\\html@mathml{\\@varsupsetneqq}{\u2acc}"),
      Nr("\\imath", "\\html@mathml{\\@imath}{\u0131}"),
      Nr("\\jmath", "\\html@mathml{\\@jmath}{\u0237}"),
      Nr(
        "\\llbracket",
      ...
      Nr("\\Complex", "\\mathbb{C}"),
      Nr("\\Dagger", "\\ddagger"),
      Nr("\\diamonds", "\\diamondsuit"),
      Nr("\\empty", "\\emptyset"),
      Nr("\\Epsilon", "\\mathrm{E}"),
      Nr("\\Eta", "\\mathrm{H}"),
      Nr("\\exist", "\\exists"),
      Nr("\\harr", "\\leftrightarrow"),
      Nr("\\hArr", "\\Leftrightarrow"),
      Nr("\\Harr", "\\Leftrightarrow"),
      Nr("\\hearts", "\\heartsuit"),
      Nr("\\image", "\\Im"),
      ...
      Nr("\\weierp", "\\wp"),
      Nr("\\Zeta", "\\mathrm{Z}"),
      Nr("\\argmin", "\\DOTSB\\operatorname*{arg\\,min}"),
      Nr("\\argmax", "\\DOTSB\\operatorname*{arg\\,max}"),
      Nr("\\plim", "\\DOTSB\\mathop{\\operatorname{plim}}\\limits"),
      Nr("\\bra", "\\mathinner{\\langle{#1}|}"),
      Nr("\\ket", "\\mathinner{|{#1}\\rangle}"),
      Nr("\\braket", "\\mathinner{\\langle{#1}\\rangle}"),
      Nr("\\Bra", "\\left\\langle#1\\right|"),
      Nr("\\Ket", "\\left|#1\\right\\rangle"));
    const Hn = (e) => (t) => {
    ...
    (Nr("\\bra@ket", Hn(!1)),
      ...
      Nr("\\set", "\\bra@set{\\{\\,}{\\mid}{}{\\,\\}}"),
      Nr("\\angln", "{\\angl n}"),
      Nr("\\blue", "\\textcolor{##6495ed}{#1}"),
      Nr("\\orange", "\\textcolor{##ffa500}{#1}"),
      Nr("\\pink", "\\textcolor{##ff00af}{#1}"),
      Nr("\\red", "\\textcolor{##df0030}{#1}"),
      Nr("\\green", "\\textcolor{##28ae7b}{#1}"),
      Nr("\\gray", "\\textcolor{gray}{#1}"),
      Nr("\\purple", "\\textcolor{##9d38bd}{#1}"),
      Nr("\\blueA", "\\textcolor{##ccfaff}{#1}"),
      Nr("\\blueB", "\\textcolor{##80f6ff}{#1}"),
      Nr("\\blueC", "\\textcolor{##63d9ea}{#1}"),
      Nr("\\blueD", "\\textcolor{##11accd}{#1}"),
      Nr("\\blueE", "\\textcolor{##0c7f99}{#1}"),
      Nr("\\tealA", "\\textcolor{##94fff5}{#1}"),
      Nr("\\tealB", "\\textcolor{##26edd5}{#1}"),
      Nr("\\tealC", "\\textcolor{##01d1c1}{#1}"),
      Nr("\\tealD", "\\textcolor{##01a995}{#1}"),
      Nr("\\tealE", "\\textcolor{##208170}{#1}"),
      Nr("\\greenA", "\\textcolor{##b6ffb0}{#1}"),
      Nr("\\greenB", "\\textcolor{##8af281}{#1}"),
      Nr("\\greenC", "\\textcolor{##74cf70}{#1}"),
      Nr("\\greenD", "\\textcolor{##1fab54}{#1}"),
      Nr("\\greenE", "\\textcolor{##0d923f}{#1}"),
      Nr("\\goldA", "\\textcolor{##ffd0a9}{#1}"),
      Nr("\\goldB", "\\textcolor{##ffbb71}{#1}"),
      Nr("\\goldC", "\\textcolor{##ff9c39}{#1}"),
      Nr("\\goldD", "\\textcolor{##e07d10}{#1}"),
      Nr("\\goldE", "\\textcolor{##a75a05}{#1}"),
      Nr("\\redA", "\\textcolor{##fca9a9}{#1}"),
      Nr("\\redB", "\\textcolor{##ff8482}{#1}"),
      Nr("\\redC", "\\textcolor{##f9685d}{#1}"),
      Nr("\\redD", "\\textcolor{##e84d39}{#1}"),
      Nr("\\redE", "\\textcolor{##bc2612}{#1}"),
      Nr("\\maroonA", "\\textcolor{##ffbde0}{#1}"),
      Nr("\\maroonB", "\\textcolor{##ff92c6}{#1}"),
      Nr("\\maroonC", "\\textcolor{##ed5fa6}{#1}"),
      Nr("\\maroonD", "\\textcolor{##ca337c}{#1}"),
      Nr("\\maroonE", "\\textcolor{##9e034e}{#1}"),
      Nr("\\purpleA", "\\textcolor{##ddd7ff}{#1}"),
      Nr("\\purpleB", "\\textcolor{##c6b9fc}{#1}"),
      Nr("\\purpleC", "\\textcolor{##aa87ff}{#1}"),
      Nr("\\purpleD", "\\textcolor{##7854ab}{#1}"),
      Nr("\\purpleE", "\\textcolor{##543b78}{#1}"),
      Nr("\\mintA", "\\textcolor{##f5f9e8}{#1}"),
      Nr("\\mintB", "\\textcolor{##edf2df}{#1}"),
      Nr("\\mintC", "\\textcolor{##e0e5cc}{#1}"),
      Nr("\\grayA", "\\textcolor{##f6f7f7}{#1}"),
      Nr("\\grayB", "\\textcolor{##f0f1f2}{#1}"),
      Nr("\\grayC", "\\textcolor{##e3e5e6}{#1}"),
      Nr("\\grayD", "\\textcolor{##d6d8da}{#1}"),
      Nr("\\grayE", "\\textcolor{##babec2}{#1}"),
      Nr("\\grayF", "\\textcolor{##888d93}{#1}"),
      Nr("\\grayG", "\\textcolor{##626569}{#1}"),
      Nr("\\grayH", "\\textcolor{##3b3e40}{#1}"),
      Nr("\\grayI", "\\textcolor{##21242c}{#1}"),
      Nr("\\kaBlue", "\\textcolor{##314453}{#1}"),
      Nr("\\kaGreen", "\\textcolor{##71B307}{#1}"));
    ...
    class En {
      constructor(e, t, r) {
        ((this.settings = void 0),
          ...
          this.feed(e),
          (this.macros = new Tn(Bn, t.macros)),
          (this.mode = r),
          (this.stack = []));
      }
      feed(e) {
      ...
      expandTokens(e) {
        ...
        for (this.pushTokens(e); this.stack.length > r; )
          if (!1 === this.expandOnce(!0)) {
            const e = this.stack.pop();
            (e.treatAsRelax && ((e.noexpand = !1), (e.treatAsRelax = !1)),
              t.push(e));
          }
      ...
      isExpandable(e) {
        ...
        return null != t
          ...
          : wn.hasOwnProperty(e) && !wn[e].primitive;
      }
    }
    const Ln =
    ...
    class Fn {
      ...
      handleInfixNodes(e) {
        ...
        if (-1 !== r && t) {
          ...
          return (
            ...
            (o =
              1 === i.length && "ordgroup" === i[0].type
                ? i[0]
                : { type: "ordgroup", mode: this.mode, body: i }),
            (a =
              "\\\\abovefrac" === t
                ? this.callFunction(t, [n, e[r], o], [])
                : this.callFunction(t, [n, o], [])),
            [a]
          );
        }
        return e;
      ...
      parseAtom(e) {
        ...
        for (;;) {
          ...
          if ("\\limits" === e.text || "\\nolimits" === e.text) {
            ...
            if (r) throw new n("Double superscript", e);
            const t = { type: "textord", mode: this.mode, text: "\\prime" },
              o = [t];
            for (this.consume(); "'" === this.fetch().text; )
              (o.push(t), this.consume());
            ("^" === this.fetch().text &&
              o.push(this.handleSupSubscript("superscript")),
              (r = { type: "ordgroup", mode: this.mode, body: o }));
          } else {
            if (!Dn[e.text]) break;
            {
              ...
              t
                ? (o = { type: "ordgroup", mode: "math", body: s })
                : (r = { type: "ordgroup", mode: "math", body: s });
            }
          }
        }
        return r || o
          ? { type: "supsub", mode: this.mode, base: t, sup: r, sub: o }
          : t;
      }
      parseFunction(e, t) {
        const r = this.fetch(),
          ...
          s = wn[o];
        if (!s) return null;
        if ((this.consume(), t && "atom" !== t && !s.allowedInArgument))
          throw new n(
            "Got function '" +
              o +
              "' with no arguments" +
      ...
      callFunction(e, t, r, o, s) {
        const i = { funcName: e, parser: this, token: o, breakOnTokenText: s },
          a = wn[e];
      ...
      parseGroupOfType(e, t, r) {
        switch (t) {
          ...
          case "hbox": {
            ...
            return null != e
              ? { type: "styling", mode: e.mode, body: [e], style: "text" }
              : null;
          }
          case "raw": {
            const e = this.parseStringGroup("raw", r);
            return null != e
              ? { type: "raw", mode: "text", string: e.text }
              : null;
          }
          case "primitive": {
      ...
      parseSizeGroup(e) {
        ...
        if (!D(s)) throw new n("Invalid unit: '" + s.unit + "'", t);
      ...
      parseGroup(e, t) {
        ...
        if ("{" === o || "\\begingroup" === o) {
          ...
          null == s && "\\" === o[0] && !On.hasOwnProperty(o))
        ) {
      ...
      parseSymbol() {
        ...
        if (/^\\verb[^a-zA-Z]/.test(t)) {
          ...
          const r = "*" === e.charAt(0);
          if (
            (r && (e = e.slice(1)), e.length < 2 || e.charAt(0) !== e.slice(-1))
          )
            throw new n(
          ...
          return (
            (e = e.slice(1, -1)),
            { type: "verb", mode: "text", body: e, star: r }
          );
        }
        Pn.hasOwnProperty(t[0]) &&
          !oe[this.mode][t[0]] &&
        ...
        if (
          ...
          (this.settings.strict &&
            ...
            (o = { type: "textord", mode: "text", loc: qr.range(e), text: t }));
        }
        if ((this.consume(), r))
          for (let t = 0; t < r[0].length; t++) {
            ...
            if (!i)
              throw new n(
                "Accent " + s + " unsupported in " + this.mode + " mode",
                e,
              );
            o = {
              type: "accent",
    ...
    const Yn = function (e, t, r) {
        ...
        const o = Pe.makeSpan(["katex-error"], [new Z(t)]);
        return (
